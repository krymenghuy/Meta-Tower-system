...
{
    protected $signature = 'build:view {view_name : view file name. Example, master} {--o|output= : The output directory (optional)}';

    // protected $signature = "build:view
    ...
    {
        $base_name = $this->argument('view_name'); /** master file name. that is generally "master" for the file "master.blade.php" */
        ...
        $res = $compressor->buildMasterView($output_dir,$base_name);
