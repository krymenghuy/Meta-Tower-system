...
use App\Http\Controllers\Ypg\EmployeeBenefitController;
use App\Http\Controllers\Ypg\DashboardController;
use App\Http\Controllers\Ypg\EmployeeController;
use App\Http\Controllers\Ypg\JobLevelController;
use App\Http\Controllers\Ypg\PayrollController;
use App\Http\Controllers\Ypg\PayrollListController;
use App\Http\Controllers\Ypg\SkillController;
use App\Http\Controllers\Ypg\LeaveController;
use App\Http\Controllers\CompanyProfileController;
use App\Http\Controllers\Login\LoginController;
use App\Http\Middleware\CustomRateLimiter;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\Ypg\DepartmentController;
use App\Http\Controllers\Ypg\PositionController;
use App\Http\Controllers\Ypg\ReportController;
use App\Http\Controllers\Ypg\WarningController;
use App\Http\Controllers\Ypg\WorkShiftController;
//use App\Http\Controllers\Ypg\ShiftDetailController;
use App\Http\Controllers\Ypg\ScanPlanController;
use App\Http\Controllers\Ypg\AttendanceController;
use App\Http\Controllers\Ypg\SalaryHistoryController;
use App\Http\Controllers\Ypg\EventController;
use App\Http\Controllers\Ypg\EmployeeEventController;
use App\Http\Controllers\Ypg\EducationController;
use App\Http\Controllers\Ypg\ExperienceController;
use App\Http\Controllers\Ypg\AccountController;
use App\Http\Controllers\Ypg\BenefitController;
use App\Http\Controllers\Ypg\BenefitCategoryController;
use App\Http\Controllers\Ypg\BenefitDisbursementController;
use App\Http\Controllers\Ypg\HolidayController;
use App\Http\Controllers\Ypg\TaxAllowanceController;
use App\Http\Controllers\Ypg\TaxBracketController;
use App\Http\Controllers\Ypg\TransactionController;
use App\Http\Controllers\Ypg\PromoteEmployeeController;
use App\Http\Controllers\Ypg\ShiftDetailsController;
use App\Http\Controllers\Ypg\GeneralSettingsController;
use App\Http\Controllers\Ypg\BenefitDisbursePolicyController;
use App\Http\Controllers\Ypg\CheckPointCategoryController;
use App\Http\Controllers\Ypg\CheckPointController;
use App\Http\Controllers\Ypg\EmployeeSkillController;
//use App\Http\Controllers\Ypg\ExitCheckpointsController;
use App\Http\Controllers\Ypg\ExitFormController;
use App\Http\Controllers\Ypg\ExitFormItemController;
//use App\Http\Controllers\Ypg\ExitStatusController;
use App\Http\Controllers\Ypg\EmployeeDocumentController;
//use App\Http\Controllers\Ypg\ExitItemController;
//use App\Http\Controllers\Ypg\FormController;
use App\Http\Controllers\Ypg\ContractController;
use App\Http\Controllers\Ypg\DocumentTypeController;
use App\Http\Controllers\Ypg\OrganizationController;
use App\Http\Controllers\Ypg\SchoolController;
