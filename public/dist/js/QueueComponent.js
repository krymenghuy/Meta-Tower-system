"use strict";let TicketDetails=new function(){let mThis=this;mThis.current_view_name='info';mThis.tblTickets=null;this.icon_url=()=>{return`${VSUtil.asset_url()}/images/icons`;}
...
div_workspace.html(html);$('#_generate_patient_inv').on('click',function(e){e.preventDefault();let d=$(this).data('tid');});div.show();LocaleManager.translateZone(ws_id);mThis.current_view_name='info';});}
...
window.addEventListener('DOMContentLoaded',e=>{TicketDetails.init('_qul_tblTickets');QueueComponent.init();});