var AccountMenagmentComponent = new (function () {
        ...
        },
        {
            ...
            <div class="d-flex justify-content-end align-items-end">
                <div class="text-end gap-2 d-flex flex-wrap">
                    <a href="javascript:void(0)" class="${data.action_id > 1 ? "d-none" : "btn_account_action"}" data-id="${data.id}" data-statusid="${data.status_id}" aria-haspopup="true" aria-expanded="false">
    ...
    this.deleteAccount = (id, menuLink) => {
        ...
        cv_interact.confirm('Delete this Account?',{
            ...
            if(e){
                vsapi.call(`${main_view.base_url}/hr/account/delete`,op,false,false,false).then(res => {
    ...
    this.prepareFormOptions = () => {
        ...
        vsapi.call(`${main_view.base_url}/hr/account/form-options`,null,null,null).then(res => {
        ...
        dialog = dialog || new GeneralDialog({
            ...
            createContent:()=>{
                 return [`<div class="row">
                    ...
                    <div class="form-group col-6">
                        <label for="ballance" class="form-label" vslang="titles.Ballance"></label>
                        <input name="ballance" class="form-control data-input" data-field="ballance" />
                    </div>
                    <div class="form-group col-6">
            ...
            prepareFormOptions:{
               ...
               targetProp: 'accounts',
               api:{
                 endpoint: [main_view.base_url,'/hr/account/form-options'].join(''),
                 params:(op)=>{
                    return {'id':op.id};
                 }
               },
