...
var SuppliersComponent = new function(){
    ...
    this.cols = [
        ...
        },
        {
            ...
            className: "align-middle ",
            data: (data,index,tr)=>{
                return ['<div class="d-flex gap-2" ><i class="fas text-success fa-envelope mt-1"></i><span class="">',(data.email || 'គ្មាន'),'</span></div>','<div class="d-flex gap-2"><i class="fas text-warning fa-phone mt-2"></i><span class="p-1 text-primary">',data.phone_number,'</span></div>'].join('');
            }
        },
    ...
    this.initDropdownMenus = (table)=>{
        const menuOptopns = {
            ...
            menus:[
                ...
                {
                    html:'<span class="ps-2 trans-text" data-langprop="titles.Modify Supplier">Modify Supplier</span>',
                    icon:`<i class="fa-regular fa-edit fs-5"></i>`,
                    cssClass:"border-bottom pb-2",
                    name:"edit_supplier"
                },
                {
                    html:'<span class="ps-2 trans-text" data-langprop="titles.Delete Customer">Delete Supplier</span>',
                    icon:`<i class="fa-regular fa-trash-can fs-5"></i>`,
                    cssClass:"border-bottom pb-2",
                    name:"delete_supplier"
                },
                {
                    html:'<span class="ps-2 trans-text" data-langprop="titles.Change Status">Change Status</span>',
