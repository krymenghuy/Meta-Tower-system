...
var HolidayComponent = (function () {
    ...
    mThis.init = () => {
        ...
        mThis.HolidayListView = new ListView("_holiday_list", {
            fetchApi: `${main_view.base_url}/ypg/holiday/list-paginate`,
            perPage: 15,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/holiday/delete`,
                            op,
                            false,
                            false,
                            false
            ...
            buttons: [
                ...
                },
                {
                    ...
                    click: (me, btn) => {
                        ...
                        vsapi
                            .call(
                                [main_view.base_url, "/ypg/holiday/save"].join(""),
                                p,
                                btn,
                                null
                            )
