...
var WorkshiftComponent = (function () {
    ...
    mThis.init = function () {
        ...
        mThis.WorkshiftListView = () => {
            vsapi
                .call(
                    `${mThis.base_url}/ypg/shift-details/list-paginate`,mThis.getFilterData(),null,null).then((res) => {
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/shift-details/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi.call(`${main_view.base_url}/ypg/shift-details/form-options`,null,null,null).then((res) => {
                if (res.status_code === 200){
                    const d = res.data;
        ...
        dialog = new GeneralDialog({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    click: (me, btn) => {
                        ...
                        vsapi.call([ main_view.base_url,"/ypg/shift-details/save"].join(""),p,btn,null).then((res) => {
                            if (res.status_code == 200) {
                                me.hide(true, p);
            ...
            prepareFormOptions: {
                ...
                api: {
                    endpoint: [
                        main_view.base_url,
                        "/ypg/shift-details/form-options",
                    ].join(""),
                    params: (op) => {
                        return { id: op.id };
                    },
