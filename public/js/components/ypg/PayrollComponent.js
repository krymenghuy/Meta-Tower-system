...
var PayrollComponent = new (function () {
    ...
    mThis.init = () => {
        ...
        mThis.PayrollListView = new ListView("_payroll_list", {
            fetchApi: `${main_view.base_url}/ypg/payroll/list-paginate`,
            perPage: 10,
    ...
    mThis.authorizePayroll = (id, menuLink) => {
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(`${mThis.base_url}/ypg/payroll/authorize`, p)
                        .then((res) => {
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${mThis.base_url}/ypg/payroll/reset`,
                            p,
                            false,
                            null
                        )
    ...
    mThis.disbursePayroll_all = (id, menuLink) => {
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(`${mThis.base_url}/ypg/payroll/disburse-all`, p,false)
                        .then((res) => {
                            if (res.status_code === 200) {
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/payroll/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi
            .call(
                `${main_view.base_url}/ypg/payroll/form-options`,
                null,
                null,
                null
            )
