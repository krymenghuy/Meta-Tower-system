...
var PayrollListComponent = new (function () {
    ...
    mThis.init = () => {
        ...
        mThis.PayrollList_ListView = new ListView(mThis.div_payrollList,{
            fetchApi : `${main_view.base_url}/ypg/payroll/staff/list`,
            perPage: 10,
        ...
        mThis.btnCalculate.onclick = function (e) {
            ...
            cv_interact.confirm('html:<span class="fw-semibold d-block">Calculate this payroll list?</span><small>This process will calculate net payment including their salary and other benefits for all staffs in the payroll</small>', {
                ...
                if (confirmation) {
                    vsapi.call([main_view.base_url, '/ypg/payroll/calculate'].join(''), op, false, null).then(res => {
        ...
        mThis.btnDisburse.onclick = function (e) {
            ...
            cv_interact.confirm('html:<span class="d-block fw-semibold text-success">Disburse this payroll list? </span><small>This process will transfer cash to all employee`s payroll accounts</small>', {
                ...
                if (confirmation) {
                    vsapi.call([main_view.base_url, '/ypg/payroll/disburse-all'].join(''), op, false, null).then(res => {
                        if (res.status_code === 200) {
            ...
            if (!AuthManager.allowed(474)) return;
             ...
             cv_interact.confirm(
                 ...
                 function (e) {
                     if (e) {
                         vsapi
                             .call(`${mThis.base_url}/ypg/payroll/authorize`, op)
                             .then((res) => {
                                 if (res.status_code === 200) {
                                     cv_interact.success(
        ...
        mThis.btnReverse.onclick = function (e) {
            ...
            cv_interact.confirm('html:<span class="d-block fw-semibold text-success">Reverse this payroll list? </span><small>This process will transfer cash back to all master accounts</small>', {
                ...
                if (confirmation) {
                    vsapi.call([main_view.base_url, '/ypg/payroll/reverse'].join(''), op, false, null).then(res => {
                        if (res.status_code === 200) {
    ...
    mThis.viewPayment = (id, menuLink) => {
        ...
        vsapi.call(`${main_view.base_url}/ypg/payroll/staff/pay-slip`,op,false,false,false).then(res => {
            if(res.status_code == 200){
                let d = res.data;
    ...
    mThis.disburseOne = (id, emp_id,payroll_id, menuLink) => {
        ...
        cv_interact.confirm('Disburse this payroll ?',{
            ...
            if(e){
                vsapi.call(`${main_view.base_url}/ypg/payroll/disburse-one`, p, false, false, false).then(res => {
    ...
    mThis.deletePayrollList = (id, menuLink) => {
        ...
        cv_interact.confirm('Remove this staff from payroll?',{
            ...
            if(e){
                vsapi.call(`${main_view.base_url}/ypg/payroll/staff/delete`,op,false,false,false).then(res => {
                    if(res.status_code == 200){
    ...
    mThis.prepareFormOptions = (onFinish) => {
        vsapi.call(`${main_view.base_url}/ypg/payroll/staff/form-options`, null, null, null).then(res => {
    ...
    self.show = (op) => {
        dialog = dialog || new GeneralDialog({
            ...
            prepareFormOptions: {
                ...
                api: {
                    endpoint: [main_view.base_url, '/ypg/payroll/staff/form-options'].join(''),
                    params: (op) => {
                        return { 'id': op.id };
                    }
                },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    click: (me, btn) => {
                        ...
                        vsapi.call([main_view.base_url, '/ypg/payroll/staff/add-deduction'].join(''), p, btn, null)
                            .then(res => {
                                if (res.status_code === 200) {
                                    me.hide(true, p);
            ...
            buttons:[
               ...
               },
               {
                ...
                click:(me,btn)=>{
                    ...
                    vsapi.call( [main_view.base_url,'/ypg/payroll/import-staff'].join(''), p,btn,null).then(res=>{
                       if(res.status_code ==200){
