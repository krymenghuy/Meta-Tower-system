var EmployeeMovementComponent = (()=> {
    ...
    mThis.init = () => {
        ...
        mThis.MovementListView = new ListView('_emp_movement_list',{
            fetchApi : `${main_view.base_url}/ypg/emp-event/list-paginate`,
            perPage: 10,
    ...
    mThis.deleteMovement = (movement_id, menuLink) => {
        ...
        cv_interact.confirm('Delete this employee movement?',{
            ...
            if(e){
                vsapi.call(`${main_view.base_url}/ypg/emp-event/delete`,op,false,false,false).then(res => {
    ...
    mThis.prepareFormOptions = () => {
        ...
        vsapi.call(`${main_view.base_url}/ypg/emp-event/form-options`,null,null,null).then(res => {
     ...
     self.show = (op)=>{
        ...
        dialog = dialog || new GeneralDialog({
            ...
            buttons:[
               ...
               },
               {
                ...
                click:(me,btn)=>{
                    ...
                    vsapi.call( [main_view.base_url,'/ypg/emp-event/save'].join(''), p,btn,null).then(res=>{
                       if(res.status_code ==200){
                         me.hide(true,p);
            ...
            prepareFormOptions:{
               ...
               api:{
                 endpoint: [main_view.base_url,'/ypg/emp-event/form-options'].join(''),
                 params:(op)=>{
                    return {'id':op.id};
                 }
               },
