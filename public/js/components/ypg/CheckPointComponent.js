...
var CheckPointComponent = new (function () {
    ...
    mThis.init = function () {
        ...
        mThis.CheckPointListView = new ListView("_check_point_list", {
            fetchApi: `${mThis.base_url}/ypg/check-point/list-paginate`,
            perPage: 10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/check-point/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi.call(
            `${main_view.base_url}/ypg/check-point/form-options`,
            null,
            null,
            null
        )
