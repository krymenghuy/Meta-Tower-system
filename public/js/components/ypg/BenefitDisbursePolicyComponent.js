...
var BenefitDisbursePolicyComponent =  (function () {
    ...
    mThis.init = () => {
        ...
        mThis.BdpListView = new ListView("_benefit_disbursement_policy_list", {
            fetchApi: `${main_view.base_url}/ypg/disburse-policy/list-paginate`,
            perPage: 10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/disburse-policy/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi
            .call(`${main_view.base_url}/ypg/disburse-policy/form-options`, null, null, null)
            .then((res) => {
            ...
            new GeneralDialog({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me, btn) => {
                            ...
                            vsapi
                                .call(
                                    [main_view.base_url, "/ypg/disburse-policy/save"].join(
                                        ""
                                    ),
                                    p,
                                    btn,
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: [
                            main_view.base_url,
                            "/ypg/disburse-policy/form-options",
                        ].join(""),
                        params: (op) => {
                            return { id: op.id };
                        },
