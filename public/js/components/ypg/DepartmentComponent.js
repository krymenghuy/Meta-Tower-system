...
var DepartmentComponent = new (function () {
    ...
    mThis.init = () => {
        ...
        mThis.DepartmentListView = new ListView("_dep_list", {
            fetchApi: `${main_view.base_url}/ypg/department/list-paginate`,
            perPage: 10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/department/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi
            .call(
                `${main_view.base_url}/ypg/department/form-options`,
                null,
                null,
                null
            )
     ...
     self.show = (op)=>{
        ...
        dialog = new GeneralDialog({
            ...
            buttons:[
               ...
               },
               {
                ...
                click:(me,btn)=>{
                    ...
                    vsapi.call( [main_view.base_url,'/ypg/department/save'].join(''), p,btn,null).then(res=>{
                       if(res.status_code ==200){
                         me.hide(true,p);
            ...
            prepareFormOptions:{
               ...
               api:{
                 endpoint: [main_view.base_url,'/ypg/department/form-options'].join(''),
                 params:(op)=>{
                    return {'id':op.id};
                 }
               },
