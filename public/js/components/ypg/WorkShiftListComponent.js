...
var WorkShiftListComponent = (function () {
    ...
    mThis.init = () => {
        ...
        mThis.WorkShiftListsView = new ListView("_work_shift_lists", {
            fetchApi: `${mThis.base_url}/ypg/work-shifts/list-paginate`,
            perPage: 10,
        ...
        window.onresize = () => {
            sh_parent.style.maxHeight = (window.innerHeight - 250) + 'px';
        }
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/work-shifts/delete`,
                            op,
                            false,
                            false,
                            false
            ...
            buttons: [
                ...
                },
                {
                    ...
                    click: (me, btn) => {
                        ...
                        vsapi
                            .call(
                                [main_view.base_url, "/ypg/work-shifts/save"].join(
                                    ""
                                ),
                                p,
                                btn,
