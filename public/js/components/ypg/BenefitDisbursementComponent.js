...
var BenefitDisbursementComponent =  (function () {
    ...
    mThis.init = function () {
        ...
        mThis.BenefitDisburseListView = new ListView("_benefit_disburse_list", {
            fetchApi: `${mThis.base_url}/ypg/employee/benefit-disbursement/list-paginate`,
            perPage: 10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/employee/benefit-disbursement/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi
            .call(
                `${main_view.base_url}/ypg/employee/benefit-disbursement/form-options`,
                null,
                null,
                null
            )
            ...
            new GeneralDialog({
                        ...
                        click: (me, btn) => {
                            ...
                            vsapi
                                .call(
                                    [
                                        main_view.base_url,
                                        "/ypg/employee/benefit-disbursement/save",
                                    ].join(""),
                                    jl,
                                    btn,
                                    null
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: [
                            main_view.base_url,
                            "/ypg/employee/benefit-disbursement/form-options",
                        ].join(""),
                        params: (op) => {
                            return { id: op.id };
                        },
