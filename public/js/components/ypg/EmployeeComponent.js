...
var EmployeeComponent =  new function () {
    ...
    mThis.init = () => {
        ...
        mThis.EmployeeListView = new ListView(mThis.divlistView, {
            fetchApi: `${main_view.base_url}/ypg/employee/list-paginate`,
            perPage: 8,
        ...
        mThis.btnImport.onclick = (e) => {
            ...
            FileChooser.chooseFile({
                ...
                if(d){
                    vsapi.call(`${main_view.base_url}/ypg/employee/import`,{
                        file: d.dataUrl
                    },false).then(res => {
         ...
         case 'profile_view':
            {
                ...
                const p = {"id": emp_id};
                const res = await vsapi.call([main_view.base_url, '/ypg/employee/details'].join(''),p,false,null);
                const data = res.data || {};
        ...
        if (Array.isArray(data) && data[0]) {
            data.forEach((d) => {
                ...
                switch (status) {
                    case "Terminated":
                        statusColor =
                            "background-color: #24315b; color: #fff; border:1px solid rgb(201, 38, 17);";
                        break;
                    case "Resigned":
                        statusColor =
                            "background-color: #24315b; color: #fff; border:1px solid rgb(225, 225, 14);";
                        break;
                    default:
                        statusColor =
                            "background-color:#24315b; color: #fff; border:1px solid #fffbff;";
                        break;
                }
                ...
                html = [
                    ...
                    }" class="h-100" alt="Profile Picture" >`,
                    `</div>`,
    ...
    mThis.renderCardLeft = (employeeId) => {
        ...
        vsapi
            .call(
                `${main_view.base_url}/ypg/emp-skill/list-paginate`,
                p,
                null,
                false,
                false
            ...
            .then((res) => {
                ...
                document
                    ...
                    .addEventListener("click", function (e) {
                        ...
                        let btn = document.querySelector(".lnk-add-skill");
                ...
                document.querySelectorAll(".lnk-edit-skill").forEach((btn) => {
                    ...
                    .forEach((btn) => {
                        btn.addEventListener("click", function (e) {
                            ...
                            cv_interact.confirm(
                                ...
                                function (e) {
                                    if (e) {
                                        vsapi.call(`${main_view.base_url}/ypg/emp-skill/delete`, op, false, false, false)
                                            .then((res) => {
                                                if (res.status_code == 200) {
                                                    cv_interact.success("Deleted successfully");
                                                    // EmployeeComponent.EmployeeListView.showPage();
                                                    EmployeeComponent.renderCardLeft(emp_id);
                                                } else {
    ...
    mThis.renderCardCenter = (employeeId) => {
        ...
        vsapi
            .call(
                `${main_view.base_url}/ypg/education/list-all`,
                p,
                null,
                false,
                false
                ...
                <div class="card-header text-white bg-primary-custom">
                    ...
                    <div class="d-flex gap-2">
                        <a href="javascript:void(0)" id="add_school">
                            <i class="fa-brands fa-stack-exchange tool-tip fs-6" style="color:#05ff79"><span class="tool-tiptext fs-15"> + School</span></i>
                        </a>
                    </div>
                </div>
                <div class="card-body" style="overflow-y: auto; overflow-x: hidden; scrollbar-width: none;">
                            ...
                            cv_interact.confirm(
                                ...
                                function (confirmDelete) {
                                    if (confirmDelete) {
                                        vsapi
                                            .call(
                                                `${main_view.base_url}/ypg/education/delete`,
                                                { id: id },
                                                false,
                                                false,
                                                false
    ...
    mThis.renderCardRight = (employeeId) => {
        ...
        vsapi
            .call(
                `${main_view.base_url}/ypg/experience/list-all`,
                p,
                null,
                false,
                false
            ...
            .then((res) => {
                ...
                <div class="card-header text-white bg-primary-custom">
                    ...
                    <div class="d-flex gap-2">
                        <a href="javascript:void(0)" id="add_arganization">
                            <i class="fa-brands fa-stack-exchange tool-tip fs-6" style="color:#05ff79"><span class="tool-tiptext fs-15">+ Organization</span></i>
                        </a>
                    </div>
                </div>
                <div class="card-body" style="overflow-y: auto; overflow-x: hidden; scrollbar-width: none;">
                ...
                <div class="row pt-2 border-bottom border-white experience-item">
                    <div class="col-md-12 mb-2">
                        <div class="d-flex justify-content-between">
                            <h6 class="text-dark text-nowrap"> ${
                                d.organization_id
                            }</h6>
                            <div class="justify-content-end gap-2 action-buttons d-none">
                                <a href="javascript:void(0)" data-id="${
                                    d.id
                                }" class="btn-experience-modify">
                                    <small><i class="fa-regular fa-pen-to-square fs-7 text-primary"></i></small>
                                </a>
                                <a href="javascript:void(0)" data-id="${
                                    d.id
                                }" data-empid="${employeeId}" class="btn-experience-delete">
                                    <small><i class="fa-solid fa-x fs-7 text-danger"></i></small>
                                </a>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between">
                            ...
                            <small class="text-muted" style="color:#3b3a36;">${
                                d.period
                            }</small>
                        </div>
                        <small class="pb-1 d-block" style="color:#293536;"> ${
                            d.description || ""
                        } </small>
                ...
                document
                    ...
                    .forEach((item) => {
                        item.addEventListener("mouseover", () => {
                            const actions =
                                item.querySelector(".action-buttons");
                            if (actions) {
                                actions.classList.remove("d-none");
                                actions.classList.add("d-flex");
                            }
                            ...
                            cv_interact.confirm(
                                ...
                                function (confirmDelete) {
                                    if (confirmDelete) {
                                        ...
                                        vsapi
                                            .call(
                                                `${main_view.base_url}/ypg/experience/delete`,
                                                { id: id },
                                                false,
                                                false,
                                                false
    ...
    mThis.renderCardTaxAllowance = (employeeId) => {
        ...
        vsapi
            .call(
                `${main_view.base_url}/ypg/tax-allowance/list-all`,
                p,
                false,
                false,
                false
            ...
            .then((res) => {
                ...
                let html = [
                    ...
                    '<div class="card-header bg-primary-custom text-white">',
                    '<h6>Tax Allowance </h6>',
                    '<div class="d-flex"><a href="javascript:void(0)" data-empid="',
                    employeeId,
                    '" class=" lnk-add-tax-allowance">(<i class="fa fa-plus-circle"></i>)</a></div>',
                    ...
                    html += `
                        <tr>
                            ...
                            <td class="text-start">
                                <a href="javascript:void(0)" data-id="${
                                    d.id
                                }" class="lnk-edit-tax-allowance me-2">
                                    <small><i class="fa-regular fa-pen-to-square fs-7 text-primary"></i></small>
                                </a>
                                <a href="javascript:void(0)" data-id="${
                                    d.id
                                }" data-emp-id="${employeeId}" class="lnk-delete-tax-allowance">
                                    <small><i class="fa-solid fa-x fs-7 text-danger"></i></small>
                                </a>
                            </td>
                        </tr>`;
                            ...
                            cv_interact.confirm(
                                ...
                                function (e) {
                                    if (e) {
                                        vsapi
                                            .call(
                                                `${main_view.base_url}/ypg/tax-allowance/delete`,
                                                op,
                                                false,
                                                false,
                                                false
    ...
    mThis.renderEmpDocuments = (employeeId) => {
        ...
        vsapi
            .call(
                `${main_view.base_url}/ypg/emp-document/list-paginate`,
                p,
                null,
                false,
                false
            ...
            .then((res) => {
                ...
                let html = `
                    <div class="card" style="height:260px;">
                        <div class="card-header bg-primary-custom text-white">
                            <div class="d-flex">
                                <h6>Document</h6>
                                <a href="javascript:void(0)" data-empid="${employeeId}" class="lnk-add-emp-document">(<i class="fa fa-plus-circle"></i>)</a>
                            </div>
                            <a href="javascript:void(0)" id="add_document_type" data-empid="${employeeId}">
                                <i class="fa-brands fa-stack-exchange tool-tip fs-6" style="color:#05ff79"><span class="tool-tiptext fs-15">+ Document Type</span></i>
                            </a>
                        </div>
                        <div class="card-body" style="height:200px; overflow-y: auto; overflow-x: hidden; scrollbar-width: none;">
                `;
                ...
                data.map((d) => {
                    html = [
                        ...
                        <div class="row mt-2 border-bottom border-white">
                            <div class="col-md-12">
                                <div class="d-flex justify-content-between">
                                    <h6 style="color:#2b3991;">${d.description}</h6>
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="${main_view.base_url}/ypg/emp-document/download/${d.id}"
                            ...
                            cv_interact.confirm(
                                ...
                                function (e) {
                                    if (e) {
                                        vsapi
                                            .call(
                                                `${main_view.base_url}/ypg/emp-document/delete`,
                                                op,
                                                false,
                                                false,
                                                false
                ...
                document
                    .getElementById("add_document_type")
                    .addEventListener("click", function (e) {
                        e.preventDefault();
                        let op = {
                            id: null,
        ...
        mThis.MovementDialog =
            ...
            new GeneralDialog({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me, btn, divModal) => {
                            ...
                            vsapi
                                .call(
                                    `${main_view.base_url}/ypg/staff-promotion/promote`,
                                    d,
                                    btn,
                                    false
                                )
                ...
                prepareFormOptions: {
                    ...
                    targetProp: "employee",
                    api: {
                        endpoint: `${main_view.base_url}/ypg/employee/form-options`,
                        params: (op) => {
                            return { id: op.id };
                        },
                    },
                ...
                onPrepareForm: (me, data) => {
                    ...
                    // vsapi.call(
                    //         `${main_view.base_url}/ypg/staff-promotion/form-options`,
                    //         op,
                    //         false,
                    //         null
                    //     ).then((res) => {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me, btn, divModal) => {
                            ...
                            vsapi
                                .call(
                                    `${main_view.base_url}/ypg/employee/set-resign-status`,
                                    p,
                                    btn,
                                    false
                                )
        ...
        mThis.PromoteDialog =
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    targetProp: "Promote",
                    api: {
                        endpoint: `${main_view.base_url}/ypg/non-staff/promotion/form-options`,
                        params: (op) => {
                            return { id: op.id};
                        },
                        onResponse: (me, res) => {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me, btn, divModal) => {
                            ...
                            vsapi
                                .call(
                                    `${main_view.base_url}/ypg/non-staff/promote`,
                                    p,
                                    btn,
                                    false
                                )
    ...
    mThis.setTerminated = (id, lnk) => {
        ...
        InputBox2.show(inputOptions, (d) => {
            if (d) {
                ...
                vsapi
                    .call(`${mThis.base_url}/ypg/employee/set-terminate-status`, p)
                    .then((res) => {
                        if (res.status_code === 200) {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me, btn, divModal) => {
                            ...
                            vsapi
                                .call(
                                    `${main_view.base_url}/ypg/employee/set-rejoin-status`,
                                    p,
                                    btn,
                                    false
                                )
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/employee/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = (onFinish) => {
        ...
        vsapi
            .call(
                `${main_view.base_url}/ypg/employee/form-options`,
                null,
                null,
                null
            )
        ...
        dialog =
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: `${main_view.base_url}/ypg/education/form-options`,
                        params: (op) => {
        ...
        dialog =
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    targetProp: "education",
                    api: {
                        endpoint: `${main_view.base_url}/ypg/school/form-options`,
                        params: (op) => {
                            return { id: op.id };
                        },
                    },
        ...
        dialog =
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: `${main_view.base_url}/ypg/organization/form-options`,
                        params: (op) => {
                            return { id: op.id };
                        },
                    },
...
const AddDocumentType = (() => {
    ...
    self.show = (op) => {
        dialog =
            dialog ||
            new GeneralDialog({
                title: op.id ? "Edit Document Type" : "New Document Type",
                cssClass: "modal-md d-flex justify-content-center",
                createContent: () => {
                    return [
                        `<div class="form-group">
                            <label class="form-label" vslang="titles.Document Type">Document Type</label>
                            <div><input name="doc_name" class=" form-control data-input" data-field="name"></input></div>
                        </div>
                        `,
                    ].join("");
                },
                ...
                prepareFormOptions: {
                    ...
                    modifyTitle: "Edit Document Type",
                    targetProp: "document_types",
                    api: {
                        endpoint: `${main_view.base_url}/ypg/document-type/form-options`,
                        params: (op) => {
                            return { id: op.id };
                        },
                    },
        ...
        dialog =
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: `${main_view.base_url}/ypg/experience/form-options`,
                        params: (op) => {
                            return { id: op.id }; // Pass ID to fetch data for edit
                        },
                    },
        ...
        dialog =
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: `${main_view.base_url}/ypg/tax-allowance/form-options`,
                        params: (op) => {
                            return { id: op.id }; // Pass ID to fetch data for edit
                        },
                        onResponse: (me, res) => {
                    ...
                    me.deleteProfilePhoto = (emp_id) => {
                        ...
                        vsapi
                            .call(
                                [
                                    main_view.base_url,
                                    "/ypg/employee/profile/photo/delete",
                                ].join(""),
                                p,
                                false,
                                false
                    ...
                    me.saveProfilePhoto = (photo, emp_id) => {
                        ...
                        vsapi
                            .call(
                                [
                                    main_view.base_url,
                                    "/ypg/employee/profile/photo/save",
                                ].join(""),
                                p,
                                false
                            )
        ...
        dialog =
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: `${main_view.base_url}/ypg/emp-skill/form-options`,
                        params: (op) => {
                            return { id: op.id }; // Pass ID to fetch data for edit
                        },
                        onResponse: (me, res) => {
            ...
            new GeneralDialog({
                ...
                createContent: () => {
                    return `
                        <div class="row">
                            <div class="form-group col-md-6">
                                 <label for="doc_name" class="form-label" vslang="titles.Document Type">Document Type</label>
                                 <span class="text-danger" >*</span>
                            ...
                            <div class="form-group col-md-6">
                                <label class="form-label" vslang="titles.Description">Description</label>
                                <div>
                                    <input name="description" class="form-control data-input" data-field="description" />
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me) => {
                            ...
                            if (!data.description || !me.fileData) {
                            ...
                            vsapi
                                .call(
                                    `${main_view.base_url}/ypg/emp-document/save`,
                                    data,
                                    false,
                                    false
                                )
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: `${main_view.base_url}/ypg/emp-document/form-options`,
                        params: (op) => ({ id: op.id }), // Pass ID to fetch data for edit
                        onResponse: (me, res) => {
                            if (op.id) {
                                const doc = res.data;
                                me.controls.description.value = doc.description || "";
                                document.getElementById(
                                    "fileNameDisplay"
                                ).textContent =
        ...
        cv_dialog ||
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    targetProp: "data",
                    api: {
                        endpoint: `${main_view.base_url}/ypg/reports/employee/print-employee-cv`,
                        params: (op) => {
