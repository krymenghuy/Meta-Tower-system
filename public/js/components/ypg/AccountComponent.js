var AccountManagementComponent = (function () {
    ...
    mThis.init = () => {
        ...
        mThis.AccountListView = new ListView(mThis.divListView, {
            fetchApi: `${main_view.base_url}/ypg/account/payroll-account/list`,
            perPage: 10,
    ...
    mThis.viewTransaction = (id, menuLink) => {
        ...
        vsapi
            .call(
                `${main_view.base_url}/ypg/account/print-transaction`,
                op,
                false,
                false,
                false
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/account/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = (onFinish) => {
        vsapi
            .call(
                `${main_view.base_url}/ypg/account/form-options`,
                null,
                null,
                null
            )
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: [
                            main_view.base_url,
                            "/ypg/account/deposit/form-options",
                        ].join(""),
                        params: (op) => {
                            return { id: op.id };
                        },
        ...
        dialog =
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    targetProp: "accounts",
                    api: {
                        endpoint: `${main_view.base_url}/ypg/account/form-options`,
                        params: (op) => {
                            return { id: op.id };
                        },
                    },
                ...
                onPrepareForm: (me, data) => {
                    ...
                    vsapi
                        .call(
                            [main_view.base_url, "/ypg/account/get-info"].join(
                                ""
                            ),
                            p,
                            null,
