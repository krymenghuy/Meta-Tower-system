...
var TaxBracketComponent = (function () {
    ...
    mThis.init = () => {
        ...
        mThis.TaxBracketListView = new ListView("_taxBracket_list", {
            fetchApi: `${main_view.base_url}/ypg/tax-bracket/list-paginate`,
            perPage: 10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/tax-bracket/delete`,
                            op,
                            false,
                            false,
                            false
     ...
     self.show = (op)=>{
        ...
        dialog = dialog || new GeneralDialog({
            ...
            buttons:[
               ...
               },
               {
                ...
                click:(me,btn)=>{
                    ...
                    vsapi.call( [main_view.base_url,'/ypg/tax-bracket/save'].join(''), p,btn,null).then(res=>{
                       if(res.status_code ==200){
                         me.hide(true,p);
            ...
            prepareFormOptions:{
               ...
               api:{
                 endpoint: [main_view.base_url,'/ypg/tax-bracket/form-options'].join(''),
                 params:(op)=>{
                    return {'id':op.id};
                 }
               },
