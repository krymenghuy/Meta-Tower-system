...
var ExitFormItemComponent = new (function () {
    ...
    mThis.init = function () {
        ...
        mThis.ExitFormItemListView = new ListView("_exit_form_item_list", {
            fetchApi: `${mThis.base_url}/ypg/exit-form-item/list-paginate`,
            perPage: 10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/exit-form-item/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi.call(
            `${main_view.base_url}/ypg/exit-form-item/form-options`,
            null,
            null,
            null
        );
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: [
                            main_view.base_url,
                            "/ypg/exit-form-item/form-options",
                        ].join(""),
                        params: (op) => {
                            return { id: op.id };
                        },
...
const ViewFormItemDialog = (() => {
    ...
    self.show = (op) => {
        vsapi
            .call(`${main_view.base_url}/ypg/exit-form-item/list-all`, {
                emp_id: op.id,
            })
            .then((res) => {
                if (res.status_code === 200) {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                click: (me, btn) => {
                                    ...
                                    vsapi
                                        .call(
                                            `${main_view.base_url}/ypg/exit-form-item/details`,
                                            p,
                                            btn
                                        )
                                        .then((res) => {
