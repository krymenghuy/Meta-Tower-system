...
var PositionComponent =  (function () {
    ...
    mThis.init = () => {
        ...
        mThis.PositionListView = new ListView("_position_list", {
            fetchApi: `${main_view.base_url}/ypg/position/list-paginate`,
            perPage:10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/position/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi
            .call(
                `${main_view.base_url}/ypg/position/form-options`, null, null, null)
            .then((res) => {
     ...
     self.show = (op)=>{
        ...
        dialog = new GeneralDialog({
            ...
            buttons:[
            ...
            },
               {
                ...
                click:(me,btn)=>{
                    ...
                    vsapi.call( [main_view.base_url,'/ypg/position/save'].join(''), p,btn,null).then(res=>{
                       if(res.status_code ==200){
                         me.hide(true,p);
                       }else cv_interact.error(res.error_message);
                    });
            ...
            prepareFormOptions:{
               ...
               api:{
                 endpoint: [main_view.base_url,'/ypg/position/form-options'].join(''),
                 params:(op)=>{
                    return {'id':op.id};
                 }
               },
