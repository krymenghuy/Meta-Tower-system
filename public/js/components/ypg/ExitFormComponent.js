...
var ExitFormComponent = (function () {
    ...
    mThis.init = function () {
        ...
        mThis.ExitFormListView = new ListView("_exit_form_list", {
            fetchApi: `${main_view.base_url}/ypg/exit-form/list-paginate`,
            perPage: 10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/exit-form/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi.call(
            `${main_view.base_url}/ypg/exit-form/form-options`,
            null,
            null,
            null
        );
            ...
            buttons: [
                ...
                },
                {
                    ...
                    click: (me, btn) => {
                        ...
                        vsapi
                            .call(
                                [main_view.base_url, "/ypg/exit-form/save"].join(
                                    ""
                                ),
                                p,
                                btn,
        ...
        dialog = dialog ||
            new GeneralDialog({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me, btn) => {
                            ...
                            vsapi
                                .call(
                                    `${main_view.base_url}/ypg/exit-form/details`,
                                    p,
                                    btn
                                )
                                .then((res) => {
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: `${main_view.base_url}/ypg/exit-form/checkpoints`,
                        params: (op) => {
...
//         vsapi
//             .call(
//                 [main_view.base_url, "/ypg/exit-form/save-item"].join(""),
//                 op,
//                 false,
//                 null
//             )
