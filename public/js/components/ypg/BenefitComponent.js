...
var BenefitComponent =  (function () {
    ...
    mThis.init = () => {
        ...
        mThis.BenefitListView = new ListView("_benefit_list", {
            fetchApi: `${main_view.base_url}/ypg/benefit/list-paginate`,
            perPage: 10,
    ...
    mThis.deleteBenefit = (id, menuLink) => {
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call( `${main_view.base_url}/ypg/benefit/delete`, op, false, false, false)
                        .then((res) => {
    ...
    mThis.prepareFormOptions = () => {
        vsapi
            .call(`${main_view.base_url}/ypg/benefit/form-options`,null,null,null)
            .then((res) => {
