var WalletAccountComponent = (function () {
    ...
    mThis.init = () => {
        ...
        mThis.WalletAccountListView = new ListView("_wallet_account_list", {
            fetchApi: `${main_view.base_url}/ypg/account/wallet-account/list`,
            perPage: 10,
    ...
    mThis.viewWalletTransaction = (id, menuLink) => {
        ...
        vsapi.call(`${main_view.base_url}/ypg/account/print-transaction`,op,false,false,false).then(res => {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me, btn) => {
                            ...
                            vsapi.call([main_view.base_url,"/ypg/account/save",].join(""),p,btn,null).then((res) => {
                                    if (res.status_code == 200) {
                                        me.hide(true, p);
