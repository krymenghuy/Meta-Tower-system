...
var EmployeeBenefitComponent = new (function () {
    ...
    mThis.init = function () {
        ...
        mThis.EmployeeBenefitListView = new ListView("_employee_bonus_list", {
            fetchApi: `${main_view.base_url}/ypg/employee/benefit/all-list`,
            perPage: 10,
        ...
        mThis.btnImport.onclick = (e) => {
            ...
            FileChooser.chooseFile({
                ...
                if(d){
                    vsapi.call(`${main_view.base_url}/ypg/employee/benefit/import-emp-benefits`,{
                        file: d.dataUrl
                    },false).then(res => {
        ...
        window.onresize = () => {
            sh_parent.style.maxHeight = (window.innerHeight - 245) + 'px';
        }
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/employee/benefit/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi
            .call(
                `${main_view.base_url}/ypg/employee/benefit/form-options`,
                null,
                null,
                null
            )
    ...
    self.show = (op) => {
        dialog = new GeneralDialog({
            ...
            prepareFormOptions: {
                ...
                api: {
                    endpoint: `${main_view.base_url}/ypg/employee/benefit/form-options`,
                    params: (op) => ({ id: op.id }),
                },
            },
            ...
            buttons: [
                ...
                },
                {
                    ...
                    click: (me, btn) => {
                        ...
                        vsapi
                            .call(
                                `${main_view.base_url}/ypg/employee/benefit/save`,
                                p,
                                btn
                            )
                            .then((res) => {
