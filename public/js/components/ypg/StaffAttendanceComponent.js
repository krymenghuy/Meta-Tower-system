...
var StaffAttendanceComponent = (function () {
    ...
    mThis.init = function () {
        ...
        mThis.StaffAttendanceListView = new ListView(mThis.divListView, {
            fetchApi: `${mThis.base_url}/ypg/attendances/list-paginate`,
            perPage: 20,
    ...
    mThis.prepareFormOptions = () => {
        vsapi.call(`${main_view.base_url}/ypg/employee/form-options`,null,null,null).then((res) => {
