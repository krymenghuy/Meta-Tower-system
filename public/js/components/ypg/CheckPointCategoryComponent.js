...
var CheckPointCategoryComponent =  (function () {
    ...
    mThis.init = function () {
        ...
        mThis.ExitCheckpointsListView = new ListView("_exitCheckpoints_list", {
            fetchApi: `${mThis.base_url}/ypg/check-point-category/list-paginate`,
            perPage: 10,
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/ypg/check-point-category/delete`,
                            op,
                            false,
                            false,
                            false
    ...
    mThis.prepareFormOptions = () => {
        vsapi
            .call(
                `${main_view.base_url}/ypg/check-point-category/form-options`,
                null,
                null,
                null
            )
            ...
            new GeneralDialog({
                ...
                prepareFormOptions: {
                    ...
                    api: {
                        endpoint: [
                            main_view.base_url,
                            "/ypg/check-point-category/form-options",
                        ].join(""),
                        params: (op) => {
                            return { id: op.id };
                        },
