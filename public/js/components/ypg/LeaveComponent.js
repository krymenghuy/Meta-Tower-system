...
var LeaveComponent = (function () {
    ...
    mThis.init = () => {
        ...
        mThis.LeaveRequestListView = new ListView('_leave_request_list',{
            fetchApi : `${main_view.base_url}/ypg/leave/list-paginate`,
            perPage: 10,
    ...
    mThis.prepareFormOptions = () => {
        ...
        vsapi.call(`${main_view.base_url}/ypg/leave/form-options`, null, null, null)
            .then(res => {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        click: (me, btn) => {
                            ...
                            vsapi
                                .call(
                                    [main_view.base_url, "/ypg/leave/save"].join(
                                        ""
                                    ),
                                    p,
                                    btn,
