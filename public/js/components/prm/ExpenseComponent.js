...
var ExpenseComponent = (() => {
    ...
    mThis.cols = [
        ...
        },
        {
            ...
            className: "align-middle",
            data: (data) =>
                `<span class="text-prm-custom">${data.expense_no}</span>`,
        },
        {
            title: "Expense Date",
            className: "align-middle",
            data: (data) =>
                `<span class="text-prm-custom">${data.expense_date}</span>`,
        },
        {
            title: "Vendor",
            className: "align-middle",
            data: (data) =>
                `<span class="text-prm-custom">${data.vendor_name}</span>`,
        },
        {
            title: "Ref No",
            className: "align-middle",
            data: (data) =>
                `<span class="text-prm-custom">${data.reference_no}</span>`,
        },
        {
            title: "Category",
            className: "align-middle",
            data: (data) =>
                `<span class="text-prm-custom">${data.expense_category}</span>`,
        },
        {
            title: "Amount",
        ...
        cv_interact.confirm(
            ...
            function (e) {
                if (e) {
                    vsapi
                        .call(
                            `${main_view.base_url}/prm/expense/delete`,
                            op,
                            false,
                            false,
                            false,
    ...
    mThis.prepareFormOptions = (onFinish) => {
        vsapi
            .call(
                `${main_view.base_url}/prm/expense/form-options`,
                null,
                null,
                null,
            )
