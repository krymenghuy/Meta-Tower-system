    ...
    const loadBillForEdit = (me, editBillId) => {
        ...
        return vsapi
            ...
            .then((formRes) => {
                ...
                // Restore saved currency if any
                if (d.currency_code) {
                    const sel = me.divModal.querySelector(
                        '[name="currency_code"]',
                    );
                    if (sel) sel.value = d.currency_code;
                }
        ...
        new GeneralDialog({
                    ...
                    <div class="col-md-6 mt-3 mt-md-0 d-flex flex-column align-items-end">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <input type="text" name="po_number"
                                class="data-input form-control flex-grow-1"
                                data-field="bill_number" placeholder="">
                        </div>
                    </div>
                ...
                <div class="row mt-3 p-1">
                    <div class="col-lg-12 d-flex justify-content-end">
                        <div class="p-3 rounded-3 shadow-sm border" style="background:#fff; min-width:320px;">
                            ...
                            <!-- Total Amount Input + Currency Selector -->
            ...
            buttons: [
                ...
                },
                {
                    ...
                    click: (me, btn) => {
                        ...
                        //     return;
                        // }
                        // if (!p.total_amount || parseFloat(p.total_amount) <= 0) {
                        //     cv_interact.warning("Please enter a valid Total Amount.");
                        //     return;
                        // }
                        // if (!p.bill_date) {
            ...
            onPrepareForm: (me, data) => {
                const editBill_Id =
                    _currentEditBill_Id ??
                    me._editBill_Id ??
                    (PurchaseOrderDialog && PurchaseOrderDialog._editBill_Id) ??
                    (me.dataOptions && me.dataOptions.id);
                const isModify = !!editBill_Id;
                const titleEl = me.divModal.querySelector(".modal-title");
                if (titleEl) {
