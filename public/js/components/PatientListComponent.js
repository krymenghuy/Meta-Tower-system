...
//begin:: PatientListComponent
 let PatientListComponent = new function(){
        ...
        this.init = ()=>{
            ...
            //    let btn = $(this).find('a.btn_pat_action');
         ...
         window.vsapi.call(`${mThis.base_url}/api/patient/list`,p,'POST',null).then((result)=>{
             ...
             //begin::Set up columns
                 ...
                 let my_columns = [
                    ...
                    //           '<a href="javascript:void(0)" data-id="',data.id,'" data-personid="',data.person_id,'" data-statusid="',data.status_id,'" class="btn_pat_action">',
             ...
             mThis.table = mThis.tblPatients.DataTable({
              ...
              //mThis.cfg.open(mThis.tblPatients.find(`tr:last`));                
         });
