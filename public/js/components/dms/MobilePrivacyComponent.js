"use strict";
var MobilePrivacyComponent = new function () {
    const mThis = this;
    this.title_prop = "Privacy Statement";
    this.self = main_view.appContent.children('#_main_mobilePriacyComponent');
    this.elFilter_app = this.self[0].querySelector('#_mpv_filter_app');
    this.btnPrint = this.self[0].querySelector('#_mpv_btnPrint');
    this.btnSave = this.self[0].querySelector('#_mpv_btnSave');
    ...
    this.saveContent = ()=>{
        ...
        vsapi.call(`${main_view.base_url}/dms/mobile-settings/save-privacy-content`,p,null,null,null).then(res =>{
    ...
    this.displayContent = ()=>{
      let app_id =   mThis.elFilter_app.value;
      vsapi.call(`${main_view.base_url}/dms/mobile-settings/privacy-content`,{"app_id":app_id},null,null,null).then(res =>{
    ...
    this.initHtmlEditor = ()=>{
        ...
        let toolbarOptions = [
         ...
         mThis.quillEditor = new Quill('#_mpv_content', {
            modules: {
