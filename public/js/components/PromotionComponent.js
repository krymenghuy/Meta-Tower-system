...
var PromotionComponent = new function(){
    ...
    this.deletePromotion = (promo_id, user_class)=> {
        ...
        cv_interact.confirm('Delete this promotion?','Delete Promotion',(e)=>{
          if(e){
            post_ajax([mThis.base_url,'/api/deletePromotion'].join(''),p,function(err){
    ...
    this.displayPromotionList = ()=>{
       ...
       post_ajax([mThis.base_url,'/api/getPromotionList'].join(''),p,function(imgs){
           if(imgs) {
             let i =0,c;
...
//begin::PromoDialog
 var PromoDialog = new function(){
    ...
    this.btnOK.on('click',(e)=>{
         ...
         post_ajax([mThis.base_url,'/api/savePromotion'].join(''),p,(res)=>{
          if(res){
              if(res.status ==='OK'){
    ...
    this.setData = (id,onFinish)=>{
      ...
      if(id>0) {
        ...
        post_ajax([mThis.base_url,'/api/getPromotionInfo'].join(''),p,(d)=>{
            if(d) {
