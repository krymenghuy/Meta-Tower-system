...
var PickupListComponent = new function() {
        ...
        mThis.pickup_dropdown_menu = mThis.tblPickups.find('div.dropdown-menu');
          ...
          //## begin::listen to Event Notifier
                ...
                let pusher = new Pusher(main_view.PUSHER_APP_KEY,{
                 ...
                 channel.bind('onOrderCreated', function(d){
                     let data = d.data;
    ...
    this.addItemRow = (table_or_order_id,d,is_table=true,edit_mode =false)=>{
      ...
      do{
        c = display_cols[i];
        if(!c) break;
         let val = StringSanitizer.sanitizeOut(d[c]);
         let iType ='text';
    ...
    this.showQuickButtons = (tr,show_it)=>{
         ...
         //begin::display quick action buttons (Pick | Arrive)
               ...
               //if (p_tr.is(':visible')){
                if (show_it){
                    td.prepend(['<div id="pkl_quick_buttons_',order_id,'" class="pkl-quick_action_buttons animate-slide-down">',
                    ...
                    mThis.prev_quick_buttons = dx;
                    dx.removeClass('animate-slide-down');
                }    
