                ...
                let pusher = new Pusher(main_view.PUSHER_APP_KEY,{
                 ...
                 channel.bind('onNewPickupRequest', function(d){
                     ...
                     if(mThis.tblPickups.is(':visible')) {
                        ...
                        if (filter_status_id ==1 || filter_status_id ==-1) mThis.displayPickupList();
                     }
...
var PickupRequestDialog = new function() {
   ...
   //on PickupRequest Pickup Request Form
    ...
    this.addPackageRow = ()=>{
        ...
        let row_data_blank = {'barcode':null,'zone_name':null,'receiver_phone':null,'price':0,'base_fee':0,'delivery_fee':0,'df_payer':'Sendr','cod':0,'size':'','actual_kg':0,'billed_kg':0,'cod_fee':0}; 
...
//    }
   ...
   { 
       ...
       if (!data || !data[0]) { 
           ...
           data = [{'barcode':null,'zone_name':null,'receiver_phone':null,'price':0,'base_fee':0,'delivery_fee':0,'df_payer':'Sendr','cod':0,'size':'','actual_kg':0,'billed_kg':0,'cod_fee':0}];
           //return;
       }
           if (mThis.table){
