...
var BorrowersComponent = new function(){
    this.base_url = $('#__base_url').val();
    let mThis = this;
    this.self = $('#_mainBorrowersComponent');

    this.tblBorrowers = $('#_mainBorrowersComponent_table');

    this.btnAddBorrowersList = $('#btnAddBorrowersList');

    this.init = () => {
        mThis.btnAddBorrowersList.on('click', () => {
            let op = {title:'New Applicant'};
            BorrowersDialog.show(op, (p) => {
                //alert(JSON.stringify(p));
                post_ajax(mThis.base_url + '/api/save-applicant', p, function(results){
                    if(results.status == 'OK'){
                        mThis.displayBorrowersList();
                    }else{
    ...
    this.displayBorrowersList = function()
    { 
        var p = null;
...
var BorrowersDialog = new function(){
    let mThis = this;
    this.self = $('#modalAddBorrower');
    this.btnSave = $('#modalAddBorrower_btnSave');
    this.elTitle = $('#modalAddBorrower_title');

    this.elErrors = $('#modalAddBorrower_error');
