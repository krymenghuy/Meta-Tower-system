...
var LoansComponent = new function(){
    this.base_url = $('#__base_url').val();
    let mThis = this;
    this.self = $('#_mainLoansComponent');

    this.tblApplicants = $('#_mainLoansComponent_table');

    this.btnAddLoan = $('#btnAddLoan');

    this.init = () => {
        mThis.btnAddLoan.on('click', () => { 
            let op = {title:'New Approve List'};
            LoanDialog.show(op, (p) => {
...
var LoanDialog = new function(){
    let mThis = this;
    this.self = $('#modalAddLoan');
    this.btnSave = $('#modalAddLoan_btnSave');
    this.elTitle = $('#modalAddLoan_title');

    this.elErrors = $('#modalAddLoan_error');
