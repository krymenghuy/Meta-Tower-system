"use strict";
let VSDOM = new function(){

      //Insert an element right after another element
      this.insertAfter = (newNode, existingNode)=>{
     ...
     this.getClosestParentByType = (el, elementType='',try_count=null)=>{
    ...
    this.getClosestParentByClass = (el, className ='',try_count=null) =>{
        if(!try_count || try_count<=0) try_count = 100;
