...
/** This choices.js is modify in function valueComparer(). change from "value1 === value2" to "value1 == value2"  to ensure loose equality in js */
...
var Choices = /** @class */function () {
  ...
  Choices.prototype.setChoices = function (choicesArrayOrFetcher, value, label, replaceChoices) {
    ...
    if(this.containerOuter) this.containerOuter.removeLoadingState();
    this._startLoading();
  ...
  Choices.prototype._findAndSelectChoiceByValue = function (value) {
    ...
    var foundChoice = choices.find(function (choice) {
      //console.log( typeof choice.value + ' = ', typeof value);
      return _this.config.valueComparer(choice.value, value);
    });
    //console.log('foundChoice: ', foundChoice);
