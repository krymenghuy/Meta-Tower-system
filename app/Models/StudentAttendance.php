...
class StudentAttendance //extends Model
{
    ...
    function getAttendanceInfo($rows,$day,$month,$year,$student_id){
        ...
        if(in_array($day_name,$except_days)) return (object)[
            ...
            'attendance_id' => '',
            'status' => $day_name,
            'check_in_remarks' => $day_name.' no class',
            'check_out_remarks' => $day_name.' no class',
            'status_id' => 4,
            "session_date" => $date,
            'check_in_time' => '',
            'check_out_time' =>'',
        ...
        if($date>$today) return (object)[
                            ...
                            'attendance_id' => '',
                            'status' => '?',
                            'check_in_remarks' => $date.' is not comming yet',
                            'check_out_remarks' => $date.' is not comming yet',
                            'status_id' => 6,
                            "session_date" => $date,
                            'check_in_time' => '',
                            'check_out_time' => '',
