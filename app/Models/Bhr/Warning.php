...
class Warning extends Model
{
    ...
    function getWarningsListPaginate($arr, $ss)
    {
        ...
        $query = DB::table('warnings as war')
            ...
            ->selectRaw('war.id, e.id as emp_id, e.name, e.name, e.positions_id as emp_position_id,e.email as email, pos.name as position, war.issues, war.promises, war.warning, e.photo_file_name as emp_photo');
        ...
        if ($search_value) {
            ...
            $str_search = "e.e.name like '%{$search_value}%' or e.name like '%{$search_value}%' or war.promises like '%{$search_value}%' or pos.name like '%{$search_value}%'";
