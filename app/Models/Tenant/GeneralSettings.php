...
// }
    ...
    private static function buildingSpaceOptionRowsBaseQuery($tenant_id=null)
    {
    ...
    static function options_building_space($ss, $include_space_id = null, $exclude_under_maintenance = false)
    {
        ...
        // \Log::info($ss->official_id);
        $query = self::buildingSpaceOptionRowsBaseQuery($ss->official_id);
