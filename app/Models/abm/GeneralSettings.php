...
class GeneralSettings //extends Model
{
    ...
    static function options_country_zone($ss){
        return  DB::table('loc_countries as c')->where('c.branch_id',$ss->branch_id)->select('c.id','c.standard_zone',DB::raw("CONCAT(c.name,' (',c.standard_zone,')') as country_name"))->orderBy('c.name','ASC')->get();
    }
