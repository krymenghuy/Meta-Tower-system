...
class Price //extends Model
{
    ...
    static function price_list_name_exists($name,$id=null){
        ...
        $rows = DB::table('price_list_names')->where('name',$name)->whereRaw($str_id)->select("id")->take(1)->get();
        return isset($rows[0]);
    }
    ...
    function renamePriceList($new_name,$id=null,$ss=null){
       ...
       DB::table('price_list_names')->where('id',$id)->where('branch_id',$branch_id)->update(['name'=>$new_name]);
       return DV::success();
    }
