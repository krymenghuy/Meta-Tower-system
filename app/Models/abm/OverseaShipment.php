...
{   
    ...
    function save($arr, $id=null,$ss=null){
        ...
        $v_rule = [
            ...
            'total_billed_weight'=>'0|number|default =0.00',
            'total_actual_weight'=>'0|number|default =0.00',
            'cc_weight'=>'0|number|default =0.00',
            'cc_price'=>'0|number|default =0.00',
            'primary_cp_comm'=>'0|number|default =0.00',
            'secondary_cp_comm'=>'0|number|default =0.00',
            'allocated_kg'=>'0|number|default =0.00',
            'verification_status_id'=>'0|number|default =1',
            'sender_pmt_status_id'=>'0|number|default =0',
            'sender_pmt_amount'=>'0|number|default =0.00',
            'invoice_id'=>'0|number',
            'carrier_bill_id'=>'0|number',
            // 'carrier_bl_id'=>'0|number',
        ...
        $save = saveData($ss,'oversea_shipments',['id'=>$id],$inputs,[],1,0);   
    ...
    function getOverseaShipmentList(){
        ...
        return DB::table('oversea_shipments')->selectRaw('id,sender_id, remarks, zone_code, status_id, price, total_billed_weight, total_actual_weight, cc_weight, cc_price,primary_cp_comm, secondary_cp_comm, allocated_kg, verification_status_id, sender_pmt_status_id, sender_pmt_amount, invoice_id, carrier_bill_id,formatDate(create_date) as create_date,DATE_FORMAT(order_time,\'%r\') AS request_time')->get();
    }
