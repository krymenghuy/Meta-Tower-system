...
class Tenant 
{
    ...
    public function getListPaginate($arr, $ss = null){
        ...
        $query = DB::table('tenants as t')
            ->whereRaw($str_search)
            ->selectRaw("t.id,t.name,t.sex,t.legal_name,t.phone_number,t.email,t.address,$updated_at,t.update_user")->orderBy('t.id','DESC');
    ...
    public static function getDetails($id){
        return DB::table('tenants as t')
            ->where('t.id',$id)
            ->selectRaw('t.id,t.name,t.sex,t.legal_name,t.phone_number,t.email,t.address')
            ->first();
    }
