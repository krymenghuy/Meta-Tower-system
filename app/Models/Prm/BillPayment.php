...
class BillPayment
{
    ...
    public function getListPaginate(array $arr = [], $ss = null)
    {
        ...
        $query->selectRaw("
            ...
            bp.payment_date, bp.amount, bp.payment_method, bp.payer,
            bp.ref_no, bp.currency_code, bp.note,
    ...
    public static function getFormOptions($bill_id = null, $ss = null)
    {
        ...
        if ($bill_id) {
            ...
            $payments = DB::table('bill_payments')
                ...
                ->select('id', 'payment_date', 'payer', 'payment_method', 'currency_code', 'amount', 'note', 'status_id')
                ->get();
        }
