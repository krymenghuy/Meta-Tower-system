...
class Program // extends Model
{
    ...
    function save($arr,$id=null,$ss=null){
        ...
        $newID = saveData($ss,'programs',['id'=>$id],$inputs,[],$ss->branch_id);
    ...
    function list($ss=null){
        ...
        $selectRow = "p.id,p.department_id,d.name as department,p.name,p.description,p.created_at,p.create_user";
