...
class GeneralSettings //extends Model
{
    ...
    static function options_delivery_zone($ss){
        return  DB::table('zones as z')->where('z.branch_id',$ss->branch_id)->select('z.id','z.zone_code',DB::raw("CONCAT(z.zone_name,' (',z.zone_code,')') as zone_name"))->orderBy('z.zone_name','ASC')->get();
    }
    ...
    static function options_sender($ss){
        return  DB::table('sender')->where('branch_id',$ss->branch_id)->whereRaw('status_code =\'active\'')->selectRaw('CONCAT(name,\': \',code) AS sender_name,id')->orderBy('name','ASC')->get();
    }
