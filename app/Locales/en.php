...
return [
    ...
    'titles' => [
        ...
        'Floor' => 'Floor',
        'Type' => 'Type',
        'Search by unit' => 'Search by unit',
        'Search by tenant, amenity or phone' => 'Search by tenant, amenity or phone',
        'Search by tenant or invoice no' => 'Search by tenant or invoice no',
        'Search by invoice no or receipt no' => 'Search by invoice no or receipt no',
        'Search tenant, unit' => 'Search tenant, unit',
        'Search by request no. or tenant' => 'Search by request no. or tenant',
        ...
        'Search by unit or name' => 'Search by unit or name',
        'Search by name or code' => 'Search by name or code',
        'All Vendors' => 'All Vendors',
        'All Categories' => 'All Categories',
        'All Charge As' => 'All Charge As',
        'Deposit Date' => 'Deposit Date',
        'From Date' => 'From Date',
        'To Date' => 'To Date',
        'Search by Reference No' => 'Search by Reference No',
        'From Issue Date' => 'From Issue Date',
        'To Issue Date' => 'To Issue Date',
