...
class CreateUmUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('um_users', function (Blueprint $table) {
            ...
            $table->integer('official_id')->nullable()->comment('official_id is the ID value that is used to link to more meaningful details table such as Employees, Students,Parents,Viewers, Customers etc. ');
