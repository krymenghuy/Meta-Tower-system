@extends('master')
@section('page_title', 'Edit Commune')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-sm kt-portlet--responsive-mobile" id="kt_page_portlet">
                    ...
                    {{ Form::model($commune, array('route' => array('commune.update', $commune->id), 'method' => 'PUT', 'class' => 'kt-form', 'id' => 'kt_form_1', 'enctype' => 'multipart/form-data')) }}
                        {{ Form::open(array('route' => 'commune.store', 'class' => 'kt-form', 'enctype' => 'multipart/form-data', 'files'=>'true')) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="country_id"​ id="country_id" class="form-control">
                                                ...
                                                @foreach($country as $countries)
                                                    @if($countries->id == $commune->country_id)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="district_id"​ id="district_id" class="form-control">
                                                ...
                                                @foreach($district as $rows)
                                                    @if($rows->id == $commune->district_id)
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    {{ Form::button('<i class="fa fa-plus"></i> Edit Commune', array('type' => 'submit', 'class' => 'btn btn-brand mb-2')) }}
