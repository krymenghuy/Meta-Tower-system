                ...
                <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
                    <div class="kt-aside__brand kt-grid__item" id="kt_aside_brand">
                        <div class="kt-aside__brand-logo">
                            <img src="{{ asset('assets/images/icons/logo.jpg') }}" alt="image logo" class="img-logo"/>
                        </div>
                            ...
                            <div style="width:100%">
                                ...
                                <div id="_main_top_right_menus" class="mainview-top-right" style="float:right">
                                    <div class="form-inline">
                                        <div class="dropdown">
                                            <button style="display:none" id="_main_btn_lang" class="btn-dropdown" data-menu="lang" style="margin-right:10px; padding:0px; border:none; background:none">
