...
<head>
    ...
    ScriptManager::render('bhr-primary-defer', 1, 11);
    ScriptManager::render('bhr-components', 1, 142);
                ...
                <div id="_p2" class="h-100 mt-1" id="kt_content">
                    <div id="" class="h-100">
                        <div class="pb-2" id="_app_content">
                            ...
                            @include('layouts.bhr.leaveUnFormComponent')
                            ...
                            @include('layouts.bhr.exitCheckPointComponent')
                            @include('layouts.bhr.exitFormComponent')
                            @include('layouts.bhr.checkPointComponent')
