    ...
    <div class="border-style1" style="width:100%; padding:15px;">
            ...
            <div class="row">
                <div class="col-lg-10 col-md-10">
                    <div class="row">
                        <div class="form-group col-lg-3">
                            ...
                            <div><input id="_person_nid" type="text" data-field="n_id" data-required="1"
                        ...
                        <div class="form-group col-lg-3">
                            <span class="simple-label">Occupation&nbsp;<a id="_person_lnkNewOccupation"
                                    href="javascript:void(0)"><i class="fa fa-plus" style="color:green"></i></a></span>
                            <div><select id="_person_occupation" data-field="occupation_id" data-datatype="string"
                ...
                <div class="col-lg-2 col-md-2">
                    ...
                    <div class="photo-buttons">
                        ...
                        &nbsp;&nbsp;<a href="#" id="_person_lnkDeletePhoto"
            ...
            <div class="address-box">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-2">
                        ...
                        <div><select id="_person_adr_city" data-field="adr_city_id"
                                class="data-input modal-select2 person-data"></select></div>
                    </div>

                    <div class="form-group col-lg-2">
                        <span class="simple-label">District</span>
                        <div><select id="_person_adr_district" data-field="adr_district_id"
                                class="data-input modal-select2 person-data"></select></div>
                    </div>

                    <div class="form-group col-lg-2">
                        <span class="simple-label">Commune</span>
                        <div><select id="_person_adr_commune" data-field="adr_commune_id"
                                class="data-input modal-select2 person-data"></select></div>
                    </div>
                </div>
            </div>
        ...
        <div style="width:100%;margin-top:10px">
            <div id="_person_employment_view" style="width:100%;">
                <div class="alert alert-warning" style="background-color:#80DFE0;border:none;"><i
                        class="fas fa-user-graduate"></i> EMPLOYMENT INFORMATION &nbsp;<a href="javascript:void(0)"
                        data-toggle="tooltip" data-tooltip="Employment History" data-placement="top"><i
                ...
                <div id="_person_view" class="flat-box" style="margin-top:-20px;">
                    <div class="row">
                        <div class="form-group col-lg-3">
                            ...
                            <div><input data-ffield="Employment Start Date" type="text" data-required="1"
                                    data-field="emp_start_date" class="form-control data-input person-data"
                                    data-select="datepicker"></div>
                        </div>

                        <div class="form-group col-lg-5">
                            <span class="simple-label">Employment Organization &nbsp;<a id="_person_lnkNewOrg"
                                    href="javascript:void(0)"><i class="fa fa-plus" style="color:green"></i></a> </span>
                            <div><select id="_person_emp_org" data-ffield="Employer organization"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <div><input data-ffield="Position title" type="text" id="_person_emp_position"
        ...
        <div style="width:100%;margin-top:10px">
            <div id="_person_academic_view" style="width:100%;">
                ...
                <div id="_person_view" class="flat-box" style="margin-top:-20px;">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            <span class="simple-label">Program of study &nbsp;<a id="_person_lnkNewProgram"
                                    href="javascript:void(0)"><i class="fa fa-plus" style="color:green"></i></a> </span>
                            <div><select id="_person_program" data-field="program_id"
                                    class="form-control data-input modal-select2"></select></div>
                        </div>

                        <div class="form-group col-lg-2">
                            <span class="simple-label">Cumulative GPA</span>
                            <div><input type="number" id="_person_gpa" data-field="cgpa"
                                    class="form-control data-input"></div>
                        </div>
                    </div>
                </div>
            ...
            <div id="_person_documents_view" style="width:100%;display:none">
                <div class="alert alert-info" style="margin-top:10px"> <i class="fas fa-receipt"></i> SUPPORT DOCUMENTS
                    &nbsp; <a id="_person_lnkAddDocument" href="#"> <i class="fa fa-plus"></i></a></div>
                <div id="_person_docs" class="flat-box" style="margin-top:-20px">
                    <input type="file" id="_person_docs_input"
        ...
        <div style="width:100%;position:fixed;bottom:15px;">
            <div class="form-inline" style="float:left;margin-left:7vw">
                <button id="_person_btnClose" type="button" class="vs-btn-lg vs-btn-danger" style="min-width:100px"><i
                        class="fa fa-times"></i> Close</button>&nbsp;
                <button id="_person_btnModify" type="button" class="vs-btn-lg vs-btn-primary" style="min-width:100px"><i
                        class="fa fa-times"></i> Modify</button>&nbsp;
                <button id="_person_btnSave" type="button" class="vs-btn-lg  vs-btn-success"
                    style="display:none;min-width:100px"><i class="fa fa-save"></i> Save</button>
            </div>
        </div>
