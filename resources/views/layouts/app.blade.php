...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login</title>
    <link type="images/png" rel="icon" href="{{ asset('images/logo/logo.png') }}">
    ...
    <link href="{{ asset('assets/css/demo1/pages/login/login-3.css') }}" rel="stylesheet"
        type="text/css" />
...
<body>
    ...
    <script src="{{ asset('assets/js/demo1/pages/login/login-general.js') }}"
        type="text/javascript"></script>
