...
<div id="_sttn_deliveryPriceComponent" style="display:none;padding:15px">
  <div class="row">
    <div class="col-lg-12" id="_sttn_price_container">
      <div class="tab-view" id="_sttn_priceTabView">
        <div class="tab-header">
          <a href="javascript:void(0)" class="tab-button" data-viewname="prices" data-target="_sttn_tabpanel_prices">
            PRICES BY ZONE
          </a>
          <a href="javascript:void(0)" class="tab-button" data-viewname="price_script" data-target="_sttn_tabpanel_price_script">
            PRICES SCRIPT
          </a>
          <a href="javascript:void(0)" class="tab-button" data-viewname="other_fees" data-target="_sttn_tabpanel_other_fees">
            COD FEE
          </a>
          <a style="display:none" href="javascript:void(0)" class="tab-button" data-viewname="promotions" data-target="_sttn_tabpanel_promotions">
            PROMOTIONS
          </a>
        </div>
        <div class="tab-body">
          <div class="tab-panel border-style1" id="_sttn_tabpanel_prices" style="height:650px;padding:10px" data-viewname="prices">
            <div style="display:flex;flex-direction:row">
              ...
              <div style="display:block;margin-left:25px;">
                ...
                <a id="_sttn_price_lnkNewPrice" href="javascript:void(0)" class="btn btn-sm btn-outline-primary btn-hover">
            ...
            <div id="_sttn_tblPrices_wrapper" style="width:100%">
              <table id="_sttn_price_tblPrices" class="table fixed-body-table">
                ...
                <tbody id="_sttn_price_tblPrices_body" style="max-height:350px"></tbody>
              </table>
            </div>
          </div>
          <div class="tab-panel border-style1" id="_sttn_tabpanel_price_script" style="height:650px;padding:10px" data-viewname="price_script">
            <div clss="form-group col-lg-6">
              ...
              <div class="form-inline" style="margin-top:10px">
                <button type="button" id="_sttn_btnGetSample" class="btn btn-sm btn-default">
                  <i class="fa fa-code"></i>
                  Get Sample
                </button> 
                &nbsp;&nbsp;
                <button type="button" id="_sttn_btnRunScript" class="btn btn-sm btn-primary">
                  <i class="fa fa-exchange-alt"></i>
                  Translate
                </button>
                &nbsp;&nbsp;
                <button type="button" id="_sttn_btnImportScript" class="btn btn-sm btn-success">
                ...
                <div id="_sttn_tblcods_wrapper" style="width:100%">
                  <div class="display:flex;flex-direction:row">
                    <div class="buttons" style="float:left">
                      <div class ="form-inline">
                        <button type="button" id="_sttn_btnNewCOD" class="btn btn-outline-primary">
                          <i class="fa fa-plus"></i>
                          New COD Charge
                        </button>
                        <select class="modal-select2 form-control" id="_sttn_filter_cod_sender" style="margin-left:30px"></select>
                  ...
                  <div class="dms-flat-box" style="padding:10px">
                    <table id="_sttn_price_tblcods" class="table" style="width:90%">
                      ...
                      <tbody id="_sttn_price_tblcods_body" style="max-height:390px"></tbody>
                    </table>
                  </div>
                </div>
              </div>
          ...
          <div class="tab-panel border-style1" id="_sttn_tabpanel_promotions" style="height:650px;padding:10px" data-viewname="promotions">
            <div class="form-inline">
              <button id="_sttn_btnNewBaseFee" class="btn btn-primary">
                <i class="fa fa-plus"></i>
                New Promotion
              </button>
            </div>  
      ...
      <div id="sttn_price_line_panel" style="display:none;height:500px">
        <div class="row">
          <div class="col-lg-12">
            <div class="form-inline">
              <a href="javascript:void(0)" id="_sttn_btnBack">
                <i class="fa fa-angle-double-left" style="color:grren"></i>
                Back
              </a>
            </div>
        ...
        <div class="col-lg-6" style="display:grey">
          <div style="float:left;margin-top:15px">
            <span id="_sttn_price_error" class="error_text"></span>
          </div> 
          <div style="float:right;margin-top:15px">
            <button id="_sttn_btnBack1" class="btn btn-outline-primary">
              <i class="fa fa-angle-double-left" style="color:grey"></i>
              Back
            </button> 
            &nbsp; &nbsp;
            <button id="_sttn_btnSavePrice" class="btn btn-outline-success">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            &nbsp;
            <a href="javascript:void(0)" id="_sttn_cod_lnkFindSender">
