     ...
     <div id="_divFilter_invoice" class="bg-white shadow-sm p-3 rounded-2" >
        <div class="align-items-center row g-3">
            <div class="col-12 col-md-6 col-lg-4" >
                ...
                <input type="text" class="filter-field rounded-2 input-search" id="_search_invoice" placeholder="Search by invoice no or unit" >
            </div>
         </div>

           <div class="col-12 col-md-6 col-lg-2">
                <select id="payment_status" class="filter-field data-input form-control" data-field="payment_status_id"></select>
            </div>
             <div class="col-12 col-md-6 col-lg-2">
