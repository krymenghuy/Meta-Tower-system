     ...
     <div id="_divFilter_receipts" class="rounded-2 p-3 bg-white shadow-lg">
        <div class="row g-3 align-items-center">
            <div class="col-12 col-md-6 col-lg-3">
                ...
                <input type="text" class="rounded-2 filter-field input-search" id="_search_receipts" placeholder="{{ \Vsd\Locales\Localization::trans('Search by invoice no or receipt no', 'titles') }}">
            </div>
         </div>
