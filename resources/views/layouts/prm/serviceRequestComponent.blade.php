     ...
     <div id="_divFilter_service_request" class="bg-white shadow-sm p-3 rounded-2">
        <div class="align-items-center row g-3">
            ...
            <div class="col-12 col-md-6 col-lg-2">
                <select id="_service_request_category_id" class="filter-field data-input form-control" data-field="category_id" placeholder='vslang="titles.All Categories"'></select>
            </div>
            <div class="col-12 col-md-6 col-lg-2">
                <select id="_service_request_status" class="filter-field data-input form-control" data-field="status_id" placeholder='vslang="titles.All Statuses"' ></select>
            </div>
