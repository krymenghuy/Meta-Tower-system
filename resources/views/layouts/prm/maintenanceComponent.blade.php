     ...
     <div id="_divFilter_maintenance" class="rounded-2 p-3 bg-white shadow-sm">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-12 col-md-6 col-lg-2 ">
                <select type="id" id="_maintenance_type_id" class="data-input filter-field form-control" data-field="maintenance_type_id"></select>
            </div>
            <div class="col-12 col-md-6 col-lg-2 ">
                <select type="id" id="_maintenance_category_id" class="data-input filter-field form-control" data-field="category_id"></select>
            </div>
            ...
            <div class="col-12 col-md-3 col-lg-2 ms-auto text-md-end" style="overflow:visible;">
                <button type="button" class="btnAddNewPrm w-100 w-md-auto" id="_btn_maintenance">
                    ...
                    <span vslang="buttons.Create"></span>
                </button>
            </div>
        </div>
    </div>
