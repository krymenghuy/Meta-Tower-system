     ...
     <div id="_divFilter_reservation" class="rounded-2 p-3 bg-white shadow-sm">
        <div class="row g-3 align-items-center">
            <div class="col-12 col-md-6 col-lg-3">
                <input type="text" class="form-control rounded-2 pe-5 filter-field input-search" id="_search_reservation" placeholder="Search By Tenant or Phone Number">
            </div>
            ...
            <div class="col-12 col-md-3 col-lg-2">
                <input id="booking_date_to" data-select="datepicker" class="form-control data-input filter-field" placeholder="To Date" data-field="booking_date_to">
            </div>
