<div id="_main_building_component" class="m-3 pt-2" style="display:none;">
     <div class="d-flex justify-content-between w-100 rounded-2 shadow p-3 mt-2" style="background-color:#ffffff;" id="_divFilter_building">
        <div class="d-flex justify-content-start gap-3 w-50">
            <div class="d-flex justify-content-start w-50 position-relative">
                <input type="text" class="form-control rounded-2 filter-field pe-5" id="_search_building" placeholder="Search">
