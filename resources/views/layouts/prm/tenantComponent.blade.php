    ...
    <div class="d-flex justify-content-between w-100 rounded-2 shadow p-3 mt-2" style="background-color:#ffffff;" id="_divFilter_tenant">
        <div class="d-flex justify-content-start gap-3 w-50">
            <div class="d-flex justify-content-start w-50 position-relative">
                <input type="text" class="form-control rounded-2 filter-field pe-5" id="_search_tenant" placeholder="Search">
        ...
        <div class="d-flex align-items-center justify-content-end w-50">
            <button type="button" class="btn_add d-flex align-items-center gap-2" id="_btnAddTenant">
                <i class="fa fa-user-plus"></i>
                <span vslang="buttons.Create Tenant"></span>
            </button>
        </div>
    </div>
    <div id="_tenant_list" class="mt-3"></div>
</div>
