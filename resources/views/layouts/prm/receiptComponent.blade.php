<div id="_main_receipt_component" class="mobile-padding p-3" style="display:none;">
     <div id="_divFilter_receipt" class="rounded-2 p-3 bg-white shadow-lg">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-12 col-md-3 col-lg-2 ms-auto text-md-end">
                <button type="button" class="btn btn--Options w-70 w-md-auto" id="_btnReceipt">
    ...
    <div id="_receipt_list" class="table-responsive  mt-3 bg-white shadow-lg rounded-2 border"></div>
</div>
<style>
