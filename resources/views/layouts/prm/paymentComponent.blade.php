<div id="_main_payment_component" class="mobile-padding px-3" style="display:none;">
     <div class="d-flex justify-content-between w-100 rounded-2 shadow p-3 mt-2" style="background-color:#ffffff;" id="_divFilter_space" >
        <div class="d-flex justify-content-start gap-3 w-50">
            <div class="d-flex justify-content-start w-50 position-relative">
                <input type="text" class="form-control rounded-2 filter-field pe-5" id="_search_space" placeholder="Search">
        ...
        <div class="d-flex align-items-center justify-content-end w-50">
            <button type="button" class="btnAddNewPrm" id="_btnPayment">
             <i class="fa-solid fa-money-check-dollar mr-2"></i>
                <span vslang="buttons.Add Payment"></span>
            </button>
        </div>
    </div>
    <div id="_payment_list" class="mt-3"></div>
</div>