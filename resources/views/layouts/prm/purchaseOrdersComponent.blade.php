<div id="_main_purchases_component" class="mobile-padding p-3" style="display:none;">
     <div id="_divFilter_purchases" class="rounded-2 p-3 bg-white shadow-sm">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-12 col-md-6 col-lg-2">
                <select placeholder='vslang="titles.All Vendors"' type="id" id="_po_vendor_id" class="data-input filter-field form-control" data-field="vendor_id"></select>
            </div>
             <div class="col-12 col-md-6 col-lg-2">
                <select placeholder='vslang="titles.All Statuses"' type="id" id="_po_status_id" class="data-input filter-field form-control" data-field="status_id"></select>
            </div>
