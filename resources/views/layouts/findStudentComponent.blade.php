<div id="_main_findStudentComponent" class="mobile-padding p-3" style="display:none">
        ...
        <div class="d-flex align-items-center justify-content-center bg-white rounded-4 p-3">
            <div class="d-block">
                ...
                <div class="d-bf d-flex aling-items-center mt-5 gap-2">
                    <input type="search" class="form-control data-input width--select-inner" data-field="name_id" placeholder="Search by Name or ID..."/>
                    <div class="width--select-inner">
                        <select class="modal-select2 form-control data-input" data-field="year"></select>
                    </div>
                    <button class="btn btn-primary btn--find" type="button">
    ...
    <div class="div--fsd" style="display:none">
