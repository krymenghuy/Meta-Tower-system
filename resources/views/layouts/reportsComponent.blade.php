                        ...
                        <div class="div-line" style="border-color:#C2EEEC;width:50%;border-width:0.8px;margin-top:5px;"></div>
                           ...
                           <div class="form-inline">
                            ...
                            <div class="form-inline" style="margin-top:20px;width:100%">
                                ...
                                <button id="_rpt_btnRunReport" type="button" class="btn btn-primary" style="float:right"><i class="fa fa-list-alt"></i> Run Report</button>
                                 &nbsp; &nbsp;
                                <button id="_rpt_btnExport_excel" type="button" class="btn btn-success" style="float:right"><i class="fa fa-file-excel"></i> Excel</button>
                            </div>
