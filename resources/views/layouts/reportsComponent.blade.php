    ...
    <div id="_rpt_filter_panel" style="border:1.1px solid #84E4EF;padding:3px;margin:35px;border-radius:5px">
        ...
        <div style="margin:35px;width:100%">
            <div class="form-inline" style="margin-top:15px">
                ...
                <select class="form-control" id="_rpt_filter_daterange" style="border:1.5px solid grey;-webkit-border:1.5px solid grey;font-weight:bold;border-radius:5px">
            ...
            <div class="form-inline" id="_opt_filter_dates">
                <div>
                    ...
                    <div>
                        <input id="_rpt_filter_startdate" class="form-control" data-select="datepicker">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div>
                        <input id="_rpt_filter_enddate" class="form-control" data-select="datepicker">
                    </div>
                </div>
            </div>
            <div class="form-inline">
                <div class="rpt_loan_collections" style="display:none">
                    ...
                    <div>
                        <select class="select2" id="_rpt_filter_loan"></select>
                    </div>
                </div>
                <div class="rpt_loan_collections rpt_adjustments" style="display:none">
                    <span class="simple-label">Receiver</span>
                    <div>
                        <select class="select2" id="_rpt_filter_user"></select>
                    </div>
                </div>
            </div>
            <div class="form-inline" style="margin-top:20px;width:100%">
                <button id="_rpt_btnRunReport" type="button" class="btn btn-primary" style="float:right">
                    <i class="fa fa-list-alt"></i>
                    Run Report
                </button>
                &nbsp;&nbsp;
                <button id="_rpt_btnExport_excel" type="button" class="btn btn-success" style="float:right">
