    ...
    <div class="row">
        <div class="col-lg-6">
            <div id="_sttn_loc_countryListpanel" class="border-style1"
                style=" background-color:#EAFAF1;padding:10px;height:570px">
        ...
        <div class="col-lg-6">
            <div class="tab-view" id="_sttn_loc_subLocationTabView">
                <div class="tab-header">
                    <a href="#" class="tab-button" data-viewname="cities" data-target="_sttn_tabpanel_cities">CITIES
                        (PROVINCE)</a>
                    <a href="#" class="tab-button" data-viewname="districts"
                        data-target="_sttn_tabpanel_districts">DISTRICTS (KHAN)</a>
                    <a href="#" class="tab-button" data-viewname="communes"
                        data-target="_sttn_tabpanel_communes">COMMUNES(SANGKAT)</a>
                </div>
                <!--begin::tab-body-->
                <div class="tab-body">
                    <div class="tab-panel border-style1" id="_sttn_tabpanel_cities" style="height:520px;padding:10px"
                        data-viewname="cities">
                        <a id="_sttn_loc_lnkNewCity" href="#" class="btn btn-sm btn-outline-success btn-hover">Add
                            City</a>
                    ...
                    <div class="tab-panel border-style1" id="_sttn_tabpanel_districts" style="height:520px;padding:10px"
                        data-viewname="districts">
                        <div class="form-inline">
                            <select class="select2" style="min-width:200px" id="_sttn_loc_filter_city"></select>
                            &nbsp;&nbsp;
                            <a id="_sttn_loc_lnkNewDistrict" class="btn btn-sm btn-outline-success btn-hover"
                                href="#">Add district</a>
                        </div>
                    ...
                    <div class="tab-panel border-style1" id="_sttn_tabpanel_communes" style="height:530px;padding:10px"
                        data-viewname="communes">
                        <div class="form-inline">
                            <select class="select2" style="min-width:200px"
                                id="_sttn_loc_filter_city_district"></select> &nbsp;
                            <select class="select2" style="min-width:200px" id="_sttn_loc_filter_district"></select>
                            &nbsp;&nbsp;
                            <a id="_sttn_loc_lnkNewCommune" href="#"
                                class="btn btn-sm btn-outline-success font-weight-bolder">Add commune</a>
                        </div>
