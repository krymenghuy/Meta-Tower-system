    ...
    <div class="row">
        <div class="col-lg-6">
            <div id="_sttn_loc_countryListpanel" class="border-style1" style="margin-top:40px;background-color:#F6FAFA;padding:10px;height:40vw">
                <span class="py-2 trans-text" style="font-size:15px;font-weight:bold;color:green" data-langprop="titles.Contries"></span>
        ...
        <div class="col-lg-6">
            <div class="tab-view" id="_sttn_loc_subLocationTabView">
                <div class="tab-header py-2">
                    <a href="javascript:void(0)" class="tab-button text-dark" data-viewname="cities" data-target="_sttn_tabpanel_cities">
                        <span class="trans-text text-uppercase" data-langprop="titles.Cities (province)"></span>
                    </a>
                    <a href="javascript:void(0)" class="tab-button text-dark" data-viewname="districts" data-target="_sttn_tabpanel_districts">
                        <span class="trans-text text-uppercase" data-langprop="titles.Districts (khan)"></span>
                    </a>
                    <a href="javascript:void(0)" class="tab-button text-dark" data-viewname="communes" data-target="_sttn_tabpanel_communes">
                ...
                <div class="tab-body bg-white">
                    <div class="tab-panel border-style1" id="_sttn_tabpanel_cities" style="height:40vw;padding:10px" data-viewname="cities">
                        <a id="_sttn_loc_lnkNewCity" href="javascript:void(0)" class="btn btn-outline-success btn-hover">
                    ...
                    <div class="tab-panel border-style1" id="_sttn_tabpanel_districts" style="height:40vw;padding:10px" data-viewname="districts">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <a id="_sttn_loc_lnkNewDistrict" class="btn btn-outline-success btn-hover" href="javascript:void(0)">
                    ...
                    <div class="tab-panel border-style1" id="_sttn_tabpanel_communes" style="height:40vw;padding:10px" data-viewname="communes">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                <a id="_sttn_loc_lnkNewCommune" href="javascript:void(0)" class="btn btn-outline-success font-weight-bolder">
          ...
          <div class="col-8">
            <div class="country-info">
              <div class="country-info-item">
                ...
                <input type="text" class="form-control data-input" data-field="name" data-ffield="Country name"/>
              </div>
              <div class="country-info-item">
                <label for="" class="simple-label">Nationality:</label>
                <input type="text" class="form-control data-input" data-field="nationality" data-ffield="Nationality"/>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-6">
            <div class="country-info-item">
              ...
              <input type="text" class="form-control data-input" data-field="capital_city" data-ffield="Capital city name"/>
            </div>
          </div>
          <div class="col-6">
            <div class="country-info-item">
              <label for="" class="simple-label">Official Language:</label>
              <input type="text" class="form-control data-input" data-field="lang_code" data-ffield="Language"/>
            </div>
          </div>
          <div class="col-6">
            <div class="country-info-item">
              <label for="" class="simple-label">Currency Code:</label>
              <input type="text" class="form-control data-input" data-field="currency_code" data-ffield="Currency code"/>
            </div>
          </div>
          <div class="col-6">
            <div class="country-info-item">
