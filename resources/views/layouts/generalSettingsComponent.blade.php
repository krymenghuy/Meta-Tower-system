        ...
        <div style="border:1.2px solid green;padding:15px;border-radius:3px;margin-top:35px;">
            <div class="row">
                <div style="width:50%;float:left">
                    <span class="vs-underlined-title">BUSINESS TYPES</span>&nbsp;<a href="javascript:;"><i
                ...
                <div class="broder-left" style="width:50%;float:right">
                    <span class="vs-underlined-title">PRODUCT TYPES</span>&nbsp;<a href="javascript:;"><i
                            class="fa fa-plus" style="color:green"></i></a>
                    <div style="padding:15px 0px 15px 15px">
            ...
            <div style="margin-top:15px">
                <button id="_rc_filter_btnSaveChanges" class="btn btn-primary"><i class="fa fa-list-alt"></i> Save
                    Changes</button>
            </div>
        </div>
    </div>
