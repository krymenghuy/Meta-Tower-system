<style>
 ...
 <div id="_main_r_queueComponent" style="display:none; padding-top:15px">
     <section class="content">
         <div class="container-fluid">
             <div class="d-flex justify-content-between" style="padding:10px">
                 <div class="d-flex col-md-6">
                     <button class="btn btn-outline-primary border border-primary rounded-pill" id="_r_qul_btnNewAppointment"><i class="fa fa-calendar-check"></i> &nbsp;<span class="trans-text" data-langprop="buttons.Add Ticket">Add Ticket</span></button>
                     <input id="_r_qul_search_ticket" style="width:50%;margin-right:10px;margin-left:10px" type="text" class="form-control" placeholder="Search ticket"/>
                    <a id="_r_qul_btnFindTicket" class="btn btn-outline-success" href="javascript:void(0)">
                        <i class="fas fa-sync-alt"></i>
                    </a>
                 </div>

                 <div class="d-flex justify-content-end col-md-4">
                     <input data-select="datepicker" class="input-sm form-control" placeholder="Filter date" id="_rqul_filter_date" autocomplete="off"/>&nbsp;
                     <select class="input-sm" placeholder="Status" id="_r_qul_filter_status"></select>
                 </div>
             </div>

             <div class="flat-box"
                 style="margin:17px; padding:15px; overflow:auto; border-color:#A0DFF3; min-height:350px;">
                 <table class="table header-light-blue header-uppercase" id="_r_qul_tblTickets" style="margin-top:-25px !important;"></table>
            </div>
        </div>
    </section>
</div>
...
<div id="_r_qul_dlgConsult" class="modal fade" tabindex="-1" aria-labelledby="consult-title" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="tab-view" id="_r_consultTabView">
                    ...
                    <div class="tab-body">
                        <div class="tab-panel border-3d" data-viewname="history" id="_r_tab_panel_history">
                            <div class="row">
                                <div class="col-xl-3 custom-width">
                                    <ul id="r_history_menus" class="nav flex-column">
                                ...
                                <div class="col-xl-9">
                                    <div id="_r_history_panel" style="width:100%">
                                    </div>
                                </div>
                            </div>
                        </div>

                        <div class="tab-panel border-3d" data-viewname="consultation" id="rtab_panel_consult">
                            <div class="row">
                                <div class="col-xl-3 custom-width">
                                    <ul id="r_consult_menus" class="nav flex-column">
                                ...
                                <div class="col-xl-9">
                                    <div id="_r_consult_panel" style="width:100%">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button id="_r_qul_dlgConsult_btnSave" class="vs-btn-custom-primary" type="button">Save</button>
            </div>
        </div>
    </div>
</div>
