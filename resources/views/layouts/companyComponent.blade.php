<div id="_main_companyComponent" style="display:none;padding:35px">
  ...
  <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="col-lg-3">
            <label class="control-label">Phone (contact person)</label>
 ...
 <div class="row">
     <div class="col-lg-6">
            <img src="<?php if(isset($logodata)) echo $logodata; ?>" id="com_imgLogo"   class="img-thumbnail" alt="" style="margin:-10px;width:270px;height:235px;"/>
      ...
      <div class="row"> 
          <div class="form-inline">
                      <button id="_main_comp_btnSaveProfile" type="button" class="btn btn-brand">
...
<script async src="{{ asset('js/CompanyComponent.js') }}"></script>