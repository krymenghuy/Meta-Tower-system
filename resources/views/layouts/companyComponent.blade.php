            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="form-group col-lg-12">
                        <label for="name_kh" class="control-label text-text" data-langprop="titles.Company Name (khmer)">Company Name (Khmer)</label>
                        <input type="text" class="form-control data-input" data-field="name_kh">
                    </div>
                    <div class="form-group col-lg-12">
                        <label for="name" class="control-label trans-text" data-langprop="titles.Company Name (English)">Company Name (English)</label>
