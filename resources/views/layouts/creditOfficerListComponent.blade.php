        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between" style="padding:10px">
                <div class="d-flex col-md-6">
                    <button class="vs-btn-md vs-btn-md-primary" id="_col_btnNewCO"><i
                            class="fa fa-list-alt"></i>&nbsp;<span class="trans-text" data-langprop="buttons.New CO">New
                            Officer</span></button>
                    <input id="_col_search" style="width:50%;margin-right:10px;margin-left:10px" type="text"
                        class="form-control" placeholder="Search officer">
                    <a id="_col_btnSearch" class="vs-btn-round vs-btn-success" href="javascript:void(0)"><i
    ...
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title​ trans-text" data-langprop="titles.New CO" id="_col_dlgCO_title">New Credit
                    Officer</h5>
            ...
            <div class="modal-body">
                <div class="row" id="dlgCO_body">
                    <div class="form-group col-lg-6">
                        ...
                        <div><input type="text" data-required="1" data-field="name" data-ffield="name"
                                class="form-control data-input" id="_co_name"></div>
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div><input type="text" data-type="phone" data-required="1" data-ffield="Phone number"
                                data-field="phone_number" class="form-control data-input" id="_col_phone_number"></div>
                    </div>

                    <div class="form-group col-lg-6">
                        <span class="simple-label trans-text" data-langprop="person.Address">Address</span>
                        <div><input type="text" data-field="address" data-ffield="address"
                                class="form-control data-input" id="_col_address"></div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="_col_dlgCO_btnSave"><i
