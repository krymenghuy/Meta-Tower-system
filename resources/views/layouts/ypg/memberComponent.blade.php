<div id="_main_member_component" style="display:none;padding:20px 0 0;">
    <div class="d-flex justify-content-between w-100 rounded-2 shadow p-4" id="_divFilter_member">
        <div class="d-flex align-items-center justify-content-start w-50 gap-2">
            <div class="d-flex align-items-center w-75">
                <input type="text" class="form-control rounded-5 filter-field" id="_search_member" placeholder="Search">
            </div>
    ...
    <div id="_member_list" class="pt-3 p-4"></div>
</div>
