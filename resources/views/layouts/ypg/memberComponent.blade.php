<div id="_main_member_component" class="m-3" style="display:none;">
    <div class="d-flex justify-content-between w-100 rounded-2 shadow p-3" style="background-color:#27444a;" id="_divFilter_member">
