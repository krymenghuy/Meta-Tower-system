<div id="_main_grave_info_component" style="display:none;padding:20px 0 0;">
    <div class="d-flex justify-content-between w-100 rounded-2 shadow p-4" id="_divFilter_grave_info">
        <div class="d-flex align-items-center justify-content-start w-50 gap-2">
            <div class="d-flex align-items-center w-50">
                <input type="text" class="form-control rounded-5 filter-field" id="_search_grave_info" placeholder="Search">
            </div>
    ...
    <div id="_grave_info_list" class="pt-3 p-4"></div>
</div>
