        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between" style="padding:10px">
                <div class="d-flex col-md-6">
                    <button class="vs-btn-md vs-btn-md-primary" id="_apl_btnNewLoanApp"><i
                            class="fa fa-list-alt"></i>&nbsp;<span class="trans-text"
                            data-langprop="buttons.New Application">New Application</span></button>
                    <input id="_apl_search" style="width:50%;margin-right:10px;margin-left:10px" type="text"
                        class="form-control" placeholder="Search applicant">
