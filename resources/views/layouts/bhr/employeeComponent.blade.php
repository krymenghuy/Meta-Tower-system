...
<div id="_main_employeeComponent" style="display:none;padding:20px 0 0">
    ...
    <div class="mt-3 px-3 d-none overflow-y-auto overflow-x-hidden " style="height:600px;" id="sub_view_profile">
        <div class="employee-card d-flex p-3 bg-secondary h-info-student mb-2" data-id="" data-merchantname=""
            data-pricelistid="">
        ...
        <div class="d-none mb-2" id="btn_back">
    ...
    <div class="p-3">
        <div id="_view_profile_container"></div>
    </div>
