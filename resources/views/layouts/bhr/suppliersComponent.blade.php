...
<div id="_main_suppliersComponent" style="display:none; margin-right:15px;">
    <div class="d-flex justify-content-between shadow rounded-3 mt-3 p-3 bg-white" id="_sdl_filter_fields">
        <div class="d-flex justify-content-between w-100">
            ...
            <div class="d-flex gap-2">
                    <button id="_sdl_btnNewSupplier" data-toggle="modal" class="btn btn-primary">
                        ...
                        <span class="kt-hidden-mobile " vslang="titles.Add Supplier"></span>
                    </button>
    ...
    <div class="modal-dialog modal-lg vs-modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title " id="_sdl_dlgSupplierTitle" vslang="titles.New Supplier"></h4>
                     ...
                     <div class="col-9">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <label for="id" class="form-label " vslang="titles.Supplier ID"></label>
                            ...
                            <div class="form-group col-lg-6">
                                <label for="name" class="form-label " vslang="titles.Supplier Name"></label>
