    ...
    <div id="_job_level_list">
        {{-- <table class="table caption-top">
            ...
            <tbody>
                <tr>
                    <th scope="row">1</th>
                    <td class="job_title">Information Technology</td>
                    <td>Pro</td>
                    <td>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <tr>
                    <th scope="row">2</th>
                    <td class="job_title">Marketing</td>
                    <td>Senior</td>
                    <td>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <tr>
                    <th scope="row">3</th>
                    <td class="job_title">Backend Development</td>
                    <td>Pro</td>
                ...
                <tr>
                    <th scope="row">4</th>
                    <td class="job_title">Frontend Development</td>
                    <td>Pro</td>
                    <td>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <tr>
                    <th scope="row">5</th>
                    <td class="job_title">HR(Human Resource)</td>
                    <td>Senior</td>
                    <td>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <tr>
                    <th scope="row">6</th>
                    <td class="job_title">Full Stack Development</td>
                    <td>Pro</td>
                    <td><i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <tr>
                    <th scope="row">7</th>
                    <td class="job_title">Software Engineer</td>
                    <td>Big</td>
                    <td>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
