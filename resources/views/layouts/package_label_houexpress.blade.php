    ...
    <div class="container" style="margin-top:5px;margin:auto">  
      <div style="display:flex;flex-direction:row">
        <div class="barcode-logo">
          <img src="<?php echo isset($branch->logo_data)?$branch->logo_data:null; ?>" style="height:60px">
        </div>
        <div style="width:100%">
      ...
      <div style="width:100%;display:flex;flex-direction:column;width:100%;margin-top:-15px">
        ...
        <span class="p-barcode" style="margin:auto">{!! DNS1D::getBarcodeHTML($barcode, 'C128B',1.2,40) !!}</span>    
      </div>
      ...
      <tr>
        ...
        <td class="item-text">
          <?php 
            ...
            else $delivery_type ='រហស័';  echo ($delivery_type)?$delivery_type:'មិនកំណត់';
          ?>
        </td>
      </tr>
    </table>
