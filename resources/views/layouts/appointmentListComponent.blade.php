 <style>
  ...
  .dt-icon{
   ...
   ul#_appt_cc_list li, .apl-complaint-list li {
      font-size:1em;
      padding:3px;
   ...
   .vital-signs, .medical-condition-panel{
     padding:10px;
   ...
   #_main_appointmentListComponent .btn-outline-success, #_main_appointmentListComponent .btn-outline-primary, #_main_appointmentListComponent .btn-outline-warning{
       border-radius:15px;
   }
</style>
       ...
       <div class="container-fluid">
          ...
          <div class="d-flex justify-content-between" style="padding:10px">
              <div class="d-flex col-md-6">
                  <button class="btn btn-outline-primary border border-primary rounded-pill" id="_apl_btnNewAppointment"><i class="fa fa-calendar-check"></i> &nbsp;<span class="trans-text" data-langprop="buttons.New Appointment">New Appointment</span></button>
                  ...
                  <a id="_apl_btnFindAppt" class="btn btn-sm border border-rounded" href="javascript:void(0)" ><i class="fas fa-sync-alt"></i></a>
              </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                <div class="row" id="_apl_dlgAppt_body">
                        <div class="form-group col-lg-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append"><a  id="_appt_btnSearch" href="javascript:void(0)" class="btn btn-sm btn-outline-success"><i class="fa fa-search"></i></a></div>
                            </div> 
                        </div>
                        <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <div><input type="text" data-required="1" data-field="client_name" data-ffield="Client Name" class="form-control data-input" id="_appt_client_name"></div> 
                        </div>
                        <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-6">
                            <span class="simple-label trans-text" data-langprop="appointment.Client Phone">Phone Number</span> 
                            <div><input type="text" data-required="0" data-field="client_phone_number" data-ffield="Client Phone" class="form-control data-input" id="_appt_client_phone"></div> 
                        </div>
 
                        <div class="form-group col-lg-6">
                            <span class="simple-label trans-text" data-langprop="appointment.Patient ID">Patient ID</span> 
                            <div><input type="text" data-required="0" data-field="patient_code" data-ffield="Patient ID" class="form-control data-input" id="_appt_client_code" readOnly></div> 
                        </div>
                        ...
                        <div class="form-group col-lg-3">
                            <span class="simple-label trans-text" data-langprop="appointment.Contact Channel">Contact Channel</span> 
                            <div><select data-type="number" data-ffield="Contact Channel" data-field="channel_id" class="modal-select2 data-input" id="_appt_contact_channel"></select></div> 
                        </div>

                        <div class="form-group col-lg-3">
                            <span class="simple-label trans-text" data-langprop="appointment.Arrival Date">Date</span> 
                            <div><input type="text" data-required="1" data-field="arrival_date" data-ffield="Arrival Date" class="form-control data-input" id="_appt_arrival_date" data-select="datepicker"></div> 
                        </div>

                        <div class="form-group col-lg-3">
                            <span class="simple-label trans-text" data-langprop="appointment.Time">Time</span> 
                            <div><input type="text" data-required="1" data-field="arrival_time" data-ffield="Arrival Time" class="form-control data-input" id="_appt_arrival_time" data-select="timepicker"></div> 
                        </div>
 
                        <div class="form-group col-lg-6">
                            <span class="simple-label trans-text" data-langprop="appointment.Consultant">Consultant</span> 
                            <div><select data-type="number" data-ffield="Consultant" data-field="consultant_id" class="modal-select2 data-input" id="_appt_consultant"></select></div> 
                        </div>

                        <div class="form-group col-lg-3">
                            <span class="simple-label trans-text" data-langprop="appointment.Priority">Priority</span> 
                            <div>
                                 <select data-ffield="Appointment priority" data-field="priority" class="modal-select2 data-input">
                        ...
                        <div class="form-group col-lg-3">
                            <span class="simple-label trans-text" data-langprop="appointment.Schedule Type">Schedule Type</span> 
                            <div>
                                 <select data-ffield="Schedule type" data-field="schedule_type" class="modal-select2 data-input">
                        ...
                        <div class="form-group col-lg-12" style="display:none">
                            ...
                            <div><input type="text" data-field="notes" data-ffield="Remarks" class="form-control data-input" id="_appt_notes"></div> 
                        </div>
                        
                        <div class="form-group col-lg-12 cc-input">
                            <span class="simple-label">
                               <span class="trans-text" data-langprop="appointment.Chief Complaints">Chief Complaints</span>&nbsp;
                               <a href="javascript:void(0)" id="appt_lnkAddChiefComplaint"><i class="fa fa-plus-circle" style="color:#14B1D1;font-size:1.2em"></i></a>
                            </span>
                            <div><select data-field="chief_complaint_code" data-ffield="Chief Complaint" class="modal-select2 data-input" id="_appt_chief_complaint"></select></div> 
                        </div>
                        <div class="form-group col-lg-12 cc-input">
                        ...
                        <div class="dialog-error" style="right:15px">
                          <i class="fa fa-exclamation-triangle" style="color:red"></i>&nbsp;<span style="margin-left:15px" id="_apl_dlgAppt_error" class="dialog-error-text"></span>
                        </div>
                    </div> <!--Close row-->
            </div><!--close body-->
             <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="_apl_dlgAppt_btnSave"><i class="fa fa-save"></i><span class="trans-text" data-langprop="buttons.Save">Save</span></button>
             </div>
         </div><!--close Content--> 
     </div>
   </div>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                <div class="row" id="_apl_dlgPatient_body">
                        ...
                        <div class="form-group col-lg-3">
                            <span class="simple-label"><span class="trans-text"  data-langprop="patient.Age">Age</span>&nbsp;<span style="color:orange" id="_pat_age_unit"></span></span> 
                            <div><input type="number" data-required="0" data-field="age" data-ffield="Patient Age" class="form-control data-input-reg" id="_pat_age"></div> 
                        </div>
                        <div class="form-group col-lg-6">
                            <span class="simple-label trans-text" data-langprop="patient.Phone number">Phone Number</span> 
                            <div><input type="number" data-required="1" data-field="phone_number" data-ffield="Phone number" class="form-control data-input-reg"></div> 
                        </div>
 
                        <div class="form-group col-lg-6">
                            <span class="simple-label trans-text" data-langprop="patient.Email">Email</span> 
                            <div><input type="text" data-type="email" data-ffield="Email" data-field="email" class="form-control data-input-reg"></div> 
                        </div>

                        
                        <div class="form-group col-lg-12" style="display:none">
                            <span class="simple-label trans-text" data-langprop="patient.Remarks">Remarks</span> 
                            <div><input type="text" data-field="notes" data-ffield="Remarks" class="form-control data-input-reg"></div> 
                        </div>
                        ...
                        <div class="form-group col-lg-12 reg-only">
                            ...
                            <div class="service-reg-panel">
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        <span class="simple-label trans-text" data-langprop="patient.Service Department">Service Department</span> 
                                        <div><select data-required="0" data-field="department_id" data-ffield="Service Department" class="modal-select2 data-input" id="_pat_department" placeholder="Service department"></select></div> 
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <span class="simple-label trans-text" data-langprop="patient.Doctor Name">Doctor Name</span> 
                                        <div><select data-required="0" data-field="consultant_id" data-ffield="Consultant" class="modal-select2 data-input" id="_pat_consultant"></select></div> 
                                    </div>
                                </div>
                        ...
                        <div class="dialog-error" style="right:15px">
                           <i class="fa fa-exclamation-triangle" style="color:red"></i>&nbsp;<span style="margin-left:15px" id="_apl_dlgPatient_error" class="dialog-error-text"></span>
                        </div>
                    </div> <!--close row-->
            </div><!--close body-->
             <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> <span class="trans-text" data-langprop="buttons.Cancel">Cancel</span></button>
                        <button type="button" class="btn btn-primary" id="_apl_dlgPatient_btnSave"><i class="fa fa-register"></i><span class="trans-text" data-langprop="buttons.Save">Save</span></button>
                        <button type="button" class="btn btn-success" id="_apl_dlgPatient_btnSaveAndQueue"><i class="fa fa-queue"></i><span class="trans-text" data-langprop="buttons.Save and Queue">Save & Queue</span></button>
             </div>
         </div><!--close content--> 
     </div>
   </div>
...
<div class="modal fade" id="_qsd_dlgQService" tabindex="-1" role="dialog" aria-labelledby="_qsd_dlgQService_title" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="dialog">
    <div class="modal-content">
        <div class="modal-header">
      ...
      <div class="modal-body">
                <div class="row" id="_qsd_dlgQService_body">
                        <div class="form-group col-lg-6">
                            ...
                            <div>
                                <select data-required="1" data-field="department_id" data-ffield="Department" class="modal-select2 data-input" id="_qsd_department"></select>
                            </div> 
                        </div>
                        <div class="form-group col-lg-6">
                            <span class="simple-label trans-text" data-langprop="appointment.Consultant">Consultant</span> 
                            <div>
                                <select data-field="consultant_id" data-ffield="Consultant" class="modal-select2 data-input" id="_qsd_consultant"></select>
                            </div> 
                        </div>
                        ...
                        <div class="form-group col-lg-3" style="display:none">
                            <span class="simple-label trans-text" data-langprop="appointment.Priority">Priority</span> 
                            <div>
                                 <select data-required="0" data-ffield="Service priority" data-field="priority" class="modal-select2 data-input">
                                    <option value="Normal">Normal</option>
                                    <option value="Urgent">Urgent</option>
                                 </select>
                            </div> 
                        ...
                        <div class="form-group col-lg-3" style="display:none">
                            <span class="simple-label trans-text" data-langprop="appointment.Schedule Type">Schedule Type</span> 
                            <div>
                                 <select data-required="0" data-ffield="Schedule type" data-field="schedule_type" class="modal-select2 data-input">
                                    <option value="On demand">On Demand</option>
                                    <option value="Followup">Followup</option>
                                 </select>
                            </div> 
                        ...
                        <div class="form-group col-lg-12 cc-input" style="display:none">
                            <span class="simple-label">
                               <span class="trans-text" data-langprop="appointment.Chief Complaints">Chief Complaints</span>&nbsp;
                               <a href="javascript:void(0)" id="_qsd_lnkAddChiefComplaint"><i class="fa fa-plus-circle" style="color:#14B1D1;font-size:1.2em"></i></a>
                            </span>
                            <div><select data-field="chief_complaint_code" data-ffield="Chief Complaint" class="modal-select2 data-input" id="_qsd_chief_complaint"></select></div> 
                        </div>
                        <div class="form-group col-lg-12 cc-input">
                           <div style="padding:10px">
             ...
             <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> <span class="trans-text" data-langprop="buttons.Cancel">Cancel</span></button>
                        <button type="button" class="btn btn-primary" id="_qsd_dlgQService_btnOK"><i class="fa fa-save"></i><span class="trans-text" data-langprop="buttons.Save">Save</span></button>
             </div>
         </div><!--close Content--> 
     </div>
   </div>
