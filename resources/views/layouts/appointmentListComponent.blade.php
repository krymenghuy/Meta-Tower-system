    ...
    <div class="modal-dialog vs-modal-dialog modal-lg" role="dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row" id="_apl_dlgAppt_body">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div>
                            <input type="text" data-required="1" data-field="client_name" data-ffield="Client Name" class="form-control data-input" id="_appt_client_name"/>
                        </div>
                    </div>
                    <div class="form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div>
                            <input type="text" data-required="0" data-field="client_phone_number" data-ffield="Client Phone" class="form-control data-input" id="_appt_client_phone"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div>
                            <input type="text" data-required="0" data-field="patient_code" data-ffield="Patient ID" class="form-control data-input" id="_appt_client_code" readOnly/>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-lg-3">
                        ...
                        <div>
                            <select data-type="number" data-ffield="Contact Channel" data-field="channel_id" class="modal-select2 data-input" id="_appt_contact_channel"></select>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div>
                            <select data-type="number" data-ffield="Consultant" data-field="consultant_id" class="modal-select2 data-input" id="_appt_consultant"></select>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-lg-12 cc-input">
                        <span class="simple-label">
                            ...
                            &nbsp;
                            <a href="javascript:void(0)" id="appt_lnkAddChiefComplaint">
                                <i class="fa fa-plus-circle" style="color:#14B1D1;font-size:1.2em"></i>
                            </a>
                        </span>
                        <div>
                            <select data-field="chief_complaint_code" data-ffield="Chief Complaint" class="modal-select2 data-input" id="_appt_chief_complaint"></select>
                        </div>
                    </div>
                    <div class="form-group col-lg-12 cc-input">
                        <div style="padding:10px">
                            <ul id="_appt_cc_list" style="list-style:none"></ul>
                        </div>
                    </div>

                    <div class="dialog-error" style="right:15px">
                        <i class="fa fa-exclamation-triangle" style="color:red"></i>
                        &nbsp;<span style="margin-left:15px" id="_apl_dlgAppt_error" class="dialog-error-text"></span>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="_apl_dlgAppt_btnSave">
            ...
            <div class="modal-body">
                <div class="row" id="_apl_dlgPatient_body">
                        ...
                        <div class="service-reg-panel">
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <div>
                                        <select data-required="0" data-field="department_id" data-ffield="Service Department" class="modal-select2 data-input" id="_pat_department" placeholder="Service department"></select>
                                    </div>
                                </div>
                                <div class="form-group col-lg-6">
                                    <span class="simple-label trans-text" data-langprop="patient.Doctor Name">Doctor Name</span>
                                    <div>
                                        <select data-required="0" data-field="consultant_id" data-ffield="Consultant" class="modal-select2 data-input" id="_pat_consultant"></select>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="dialog-error" style="right:15px">
                        <i class="fa fa-exclamation-triangle" style="color:red"></i>
                        &nbsp;
                        <span style="margin-left:15px" id="_apl_dlgPatient_error" class="dialog-error-text"></span>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="_apl_dlgPatient_btnSaveAndQueue">
                    <i class="fa fa-queue"></i>
                    <span class="trans-text" data-langprop="buttons.Save and Queue">Save & Queue</span>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg" role="dialog">
        <div class="modal-content">
                ...
                <div class="row" id="_qsd_dlgQService_body">
                    ...
                    <div class="form-group col-lg-12 cc-input" style="display:none">
                        <span class="simple-label">
                            <span class="trans-text" data-langprop="appointment.Chief Complaints">Chief Complaints</span>
                            &nbsp;
                            <a href="javascript:void(0)" id="_qsd_lnkAddChiefComplaint">
                                <i class="fa fa-plus-circle" style="color:#14B1D1;font-size:1.2em"></i>
                            </a>
                        </span>
                        <div>
                            <select data-field="chief_complaint_code" data-ffield="Chief Complaint" class="modal-select2 data-input" id="_qsd_chief_complaint"></select>
                        </div>
                    </div>
                    <div class="form-group col-lg-12 cc-input">
                        <div style="padding:10px">
                            <ul id="_qsd_cc_list" style="list-style:none"></ul>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="_qsd_dlgQService_btnOK">
                    <i class="fa fa-save"></i>
                    <span class="trans-text" data-langprop="buttons.Save">Save</span>
                </button>
            </div>
