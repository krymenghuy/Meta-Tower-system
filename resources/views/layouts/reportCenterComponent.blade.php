    ...
    <div class="row">
        <div class="col-lg-6">
              <div class="report-wrapper" style="margin-bottom:15px"> 
                  ...
                  <div style="position:absolute;width:35%;height:90%;right:0"><img src="{{ asset('assets/images/icons/report.png') }}" alt="" style="width:12vw;float:right;margin-right:10%;opacity:0.7"></div>
              </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="report-wrapper" style="height:35vw">
                 <div class="row" id="_rpc_filter_fields">
                     ...
                     <div id="_rpc_no_filter_text_wrapper" class="form-group col-lg-12 no-filter-text-wrapper" style="display:none">
