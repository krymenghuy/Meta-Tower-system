        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between" style="padding:10px">
                <div class="d-flex col-md-6">
                    <button class="vs-btn-md vs-btn-md-primary" id="_bor_btnNewLoanApp"><i
                            class="fa fa-list-alt"></i>&nbsp;<span class="trans-text"
                            data-langprop="buttons.New Loan">New Loan</span></button>
                    <input id="_bor_search" style="width:50%;margin-right:10px;margin-left:10px" type="text"
                        class="form-control" placeholder="Search customer">
                    <a id="_bor_btnSearch" class="vs-btn-round vs-btn-success" href="javascript:void(0)"><i
