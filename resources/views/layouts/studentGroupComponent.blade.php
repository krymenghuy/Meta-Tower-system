        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                        <label for="dlg_sdg_program" class="form-label trans-text"
                            data-langprop="titles.Program"></label>
                        <div class="width-select-dialog">
                            <select id="dlg_sdg_program" class="modal-select2 data-input"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="width-select-dialog">
                            <select id="dlg_sdg_session" class="modal-select2 data-input"
                                data-field="session_shortcut"></select>
                        </div>
                    </div>
                    <div class="form-group col-lg-6">
            ...
            <div class="modal-footer">
                ...
                <button id="dlg_sdg_btn_save" class="btn btn-primary btn-sm btn-animate" type="button">
