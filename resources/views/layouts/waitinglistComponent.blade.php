<div id="_mainWaitingListComponent" style="display:none;">

    <div class="d-flex justify-content-between" style="padding:15px;">
        <div class="d-flex col-md-6">
          <button style="margin-right:10px;background:#d5e9f6;font-weight:bold;" class="btn btn-default" id="btnAddWaitingList">+ New Applicant</button>
    ...
    <div style="padding-left:15px;padding-right:15px;">
        <table class="table" id="_mainWaitingListComponent_table"></table>
    </div>
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalAddWaitingList" tabindex="-1" role="dialog" aria-labelledby="modalAddWaitingList_title" aria-hidden="true">
    <div class="modal-dialog modal-lg">
    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalAddWaitingList_title">Applicants List</h5>
...
<script  src="{{ asset('js/WaitingListComponent.js') }}"></script>