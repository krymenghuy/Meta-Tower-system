    ...
    <div class="d-flex justify-content-between shadow rounded-3 p-3 bg-white">
        ...
        <div class="d-flex flex-row gap-2">
            <button id="_sdl_btnNewSender" data-toggle="modal" class="btn btn-primary">
                ...
                <span class="kt-hidden-mobile trans-text" data-langprop="titles.New Merchant"></span>
            </button>
    ...
    <div class="modal-dialog modal-lg vs-modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title trans-text" id="_sdl_dlgSenderTitle" data-langprop="titles.New Merchant"></h4>
            ...
            <div class="modal-body">
                <div class="row" id="div_merchant_info">
                    ...
                    <div class="form-group col-lg-6">
                        <label for="sender_type_id" class="form-label trans-text" data-langprop="titles.Merchant Type"></label>
