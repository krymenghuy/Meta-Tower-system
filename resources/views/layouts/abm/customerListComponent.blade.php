    ...
    <div class="d-flex justify-content-between shadow rounded-3 mt-3 p-3 bg-white">
       ...
       <div class="d-flex gap-2">
            <div class="d-flex flex-row gap-2" id="_cuslist_filter_fields">
                ...
                <button id="_cuslist_btnSearch" role="button" class="btn btn-primary height">
        ...
        <div class="d-flex flex-row  gap-2" >
            <button id="_cuslist__btnNewCustomer" data-toggle="modal" class="btn btn-warning text-white">
