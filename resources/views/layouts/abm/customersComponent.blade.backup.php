 ...
 <div id="_main_customersComponent"  style="display:none;">
    <div class="d-flex w-100  justify-content-between bg-white shadow rounded-3  mt-3 p-3" id="_cus_filter_fields">
        <div class="d-flex flex-row gap-2  ">
            ...
            <button id="_cul_btnSearch" class="d-none btn btn-primary ml-2 mr-2" type="button"><i class="fa fa-search"></i></button>
        </div>
        ...
        <div class="d-flex gap-2">
            ...
            <button id="_cul_btnPrint" class="d-none btn btn-warning mr-3" type="button"><i class="fa fa-print"></i> <span class="trans-text" data-langprop="buttons.Print"></span></button>
        </div>
            ...
            <div class="modal-body">
                 <div class="row" id="_cul_dlgCustomer_body">
                    <div class="col-xs-12 col-md-12 col-lg-3">
                        <div class="d-flex align-items-center"> <div id="_customer_profile_photo" style="height:165px" class="mt-2 border"></div></div>
                     </div>
                     ...
                     <div class="col-9">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                               ...
                               <div> <input type="text" class="form-control data-input" placeholder="name" data-required="1" data-field="name"/></div>
                            </div>

                            <div class="form-group col-lg-12">
                              <label for="business_type" class="form-label trans-text" data-langprop="titles. Business"></label>
                              <div> <select class="modal-select2 text-primary data-input" data-field="business_type" id="_cul_business_type"></select></div>
                    ...
                    <div class="form-group col-lg-6 mt-3">
                        ...
                        <input type="email" class="form-control data-input" placeholder="" data-field="email"/>
                    </div>
                    <div class="form-group col-lg-6 mt-3">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <textarea class="form-control data-input" placeholder="" data-field="address"></textarea>
                    </div>
                </div>
