...
<div id="_sttn_supplierPriceSettingsComponent" style="display:none;padding-right:15px">
  <div class="d-flex flex-column shadow rounded-3 justify-content-between bg-white p-3">
    <div class="d-flex gap-2">
      <div class="d-flex gap-2">
        ...
        <a href="javascript:void(0)" id="ps-lnk_add_supplier_price_list">
          <i class="fa fa-plus-circle fs-5 text-success"></i>
        </a>
        <a href="javascript:void(0)" id="ps-lnk_delete_supplier_price_list" style="display:none">
          <i class="fa fa-trash fs-5 text-danger"></i>
        </a>
        <a href="javascript:void(0)" id="ps-lnk_rename_supplier_price_list" style="display:none">
      ...
      <div class="d-flex gap-2">
        <div class="d-flex gap-2">
          <div class="min-width-select">
            <select id="ps_filter_supplier_price_list" class="modal-select2"></select>
          </div>
          <div class="d-flex align-items-start">
            <button style="display:none" id="ps-lnk_Supplier_list" type="button" class="btn btn-sm btn-primary">
              <i class="fa fa-users"></i>
            </button>
          </div>
        </div>
        <div class="form-group">
          <input id="ps_pl_search_Supplier" type="text" class="form-control" placeholder="Search Supplier">
        </div>
      </div>
  ...
  <div class="table-responsive shadow rounded-3 border pe-3 ps-3 pt-0 bg-white mt-3 table-responsive-hover position-relative">
    <table class="table" id="ps-tbl-supplier-prices">
...
<div class="modal fade" id="_ps_dlgSupplierPriceLine" tabindex="-1" role="dialog" aria-labelledby="_ps_dlgSupplierPriceLineTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg vs-modal-dialog" role="dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="_ps_dlgSupplierPriceLineTitle">Add Zones</h5>
      ...
      <div class="modal-footer">
        <span id="_ps_dlgSupplierPriceLine_error" class="error_text"></span>
        <button type="button" class="btn btn-warning height" data-dismiss="modal">
          <i class="fa fa-times fs-5 text-danger"></i>
          <span>Cancel</span>
        </button>
        <button type="button" class="btn btn-success height" id="_ps_dlgSupplierPriceLine_btnOK">
...
<div class="modal fade" id="ps_dlgSupplierPriceList" tabindex="-1" role="dialog" aria-labelledby="ps_dlgSupplierPriceListTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ps_dlgSupplierPriceListTitle">Create Price List</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        <span id="ps_dlgSupplierPriceList_error" class="error_text"></span>
        <button type="button" class="btn btn-warning height" data-dismiss="modal">
          <i class="fa fa-times fs-5 text-danger"></i>
          <span>Cancel</span>
        </button>
        <button type="button" class="btn btn-success height" id="ps_dlgSupplierPriceList_btnOK">
          <i class="fa fa-check fs-5 text-success"></i>
          <span>Add</span>
        </button>
      </div>
...
<div class="modal fade" id="ps_dlgSupplierList" tabindex="-1" role="dialog" aria-labelledby="ps_dlgSupplierListTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg vs-modal-dialog modal-dialog-scrollable" role="dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ps_dlgSupplierListTitle">Supplier List</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body position-relative">
        <div class="input-group flex-nowrap bg-white p-2 position-sticky top-0">
          <input id="ps-search_Supplier" type="text" class="form-control" placeholder="Search by phone, name">
          <div class="input-group-text" id="ps-btnSearchSupplier" role="button">
            <i class="la la-search fs-5 text-success"></i>
          </div>
        </div>
        <table class="table fixed-body-table" id="ps-tblSuppliers">
          <thead>
            <tr>
              <th>No</th>
              <th>ID</th>
              ...
              <th>Phone Number</th>
              <th>
                <a href="javascript:void(0)" id="ps-lnkAddSupplier" class="btn btn-sm btn-outline-primary">
                  <i class="fa fa-user-plus"></i>
                </a>
              </th>
            </tr>
          </thead>
          <tbody id="ps-tblSuppliers_body" style="max-height:450px; overflow-y:auto"></tbody>
        </table>
      </div>
      <div class="modal-footer">
        <span id="ps_dlgSupplierList_error" class="error_text"></span>
