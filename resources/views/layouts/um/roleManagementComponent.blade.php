<style>
   ...
   #_um_roleManagementComponent table td, #_um_roleManagementComponent table th{
    font-size:0.9em;
          ...
          <div class="row">
            <div class="col-lg-4">           
                    <div class="form-inline">
                      <span style="font-size:0.9em;font-weight:bold;display:block;padding:2px;color:grey;" class="trans-text" data-langprop="titles.available roles">AVAILABLE ROLES</span>
                      &nbsp;<a href="javascript:void(0)" style="min-width:35px;text-align:center;border-radius:50%;border:1.1px dotted green;padding:3px;margin:5px;" id="_um_lnkNewRole"><i class="fa fa-plus" style="color:green;"></i></a>
                    </div>    
              ...
              <div class="col-lg-8">
                    <div class="tab-view" id="_um_roleTabView"> 
                      ...
                      <div class="tab-body">
                          <div class="tab-panel border-3d" data-viewname="users" id="_um_tab_panel_users" style="height:40vw;padding:15px;">
                          ...
                          <div class="tab-panel border-3d" data-viewname="modules" id="_um_tab_panel_modules" style="height:40vw;padding:15px;">
                          ...
                          <div class="tab-panel border-3d" data-viewname="permissions" id="_um_tab_panel_prns" style="height:40vw;padding:15px;">
                                <a href="#" id="_um_roleprn_lnk_add"><i class="fa fa-plus" style="color:green"></i> Manage</a>
                                &nbsp;&nbsp;<a href="#" id="_um_roleprn_lnkLargeView"><i class="fa fa-list-alt" style="color:orange"></i> Advanced</a>    
