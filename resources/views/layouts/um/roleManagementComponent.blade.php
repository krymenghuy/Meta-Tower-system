<style>
   ...
   /* table#_um_tblRoleMembers>tbody td{
...
<div id="_um_roleManagementComponent" style="width:auto;display:none;margin:15px 15px 15px">
    <!--begin::div.row  RoleList-->
        <div id="_um_roleListPanel" style="width:auto;display:none">
          <div class="row">
            <div class="col-lg-4">           
                    <div><span style="font-size:0.9em;font-weight:bold;padding:2px;color:grey;">AVAILABLE ROLES</span>&nbsp;   <a href="#" id="_um_lnkNewRole"><i class="fa fa-plus-circle" style="color:green;"></i></a></div>    
                    <div class="table_wrapper border-style1" style="height:40vw">
                            <table id="_um_tblRoles" class="table">
            
                                <tbody id="_um_tblRoles_body">
                                </tbody>   
                            </table>
                    </div>                  
                    ...
                    <div class="tab-view" id="_um_roleTabView"> 
                      ...
                      <div class="tab-body">
                          <div class="tab-panel border-style1" data-viewname="users" id="_um_tab_panel_users" style="height:40vw;padding:15px">
                                <span style="color:grey;font-weight:bold;font-size:1em;margin-top:10px;" id="_um_roletab_users_text">Members of the selected role</span>
                                &nbsp;<a href="#" id="_um_lnkAddRemMember">(<i class="fa fa-plus" style="color:green"></i>)</a>    
                                  <table id="_um_tblRoleMembers" class="table">
