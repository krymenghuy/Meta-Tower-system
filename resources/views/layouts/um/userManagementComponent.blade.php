<style>
  ...
  #_um_tblUsers td.col_action,#_um_tblUsers th.col_action{
    width:50px;
  }
...
<div id="_um_userManagementComponent" style="width:auto;display:none">
          ...
          <div class="row">
              <div class="col-lg-12">
                      <div class="form-inline">
                            <a href="#" id="_um_lnkNewUser" class="btn btn-sm btn-outline-success"><i class="fa fa-user-plus"></i> New User</a>               
                      ...
                      <div id="_um_tblUsers_wrapper"  class="table_wrapper" style="padding:15px;border:1px dotted grey;border-radius:5px;">
      ...
      <div id="_um_addUserPanel" class="border-style1" style="width:auto;display:none;padding:15px">
            <a href="#" id="_um_lnkbackToUserList" class="btn btn-sm btn-outline-primary"><i class="fa fa-chevron-left"></i> Back</a> 
         ...
         <div class="flat-box" style="padding:15px;margin:25px">
                    ...
                    <div class="row">          
                        <div class="col-lg-6"> 
                                    ...
                                    <div class="form-group">
                                      <label class="control-label">Login Name <span class="text text-muted" style="font-size:0.7em"> (Phone number or email)</span></label>
                                      <input type="text" class="form-control" id="_um_adduser_loginname" placeholder="phone number or email" />
                                    </div>
