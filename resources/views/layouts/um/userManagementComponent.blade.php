...
<div id="_um_userManagementComponent" class="mobile-padding" style="width:auto;display:none">
          ...
          <div class="row">
              <div class="col-lg-12">
                      <div class="form-inline">
                            <a href="javascript:void(0)" class="btn btn-outline-success" id="_um_lnkNewUser"><i class="fa fa-user-plus" style="color:green;"></i> New User</a>               
      ...
      <div id="_um_addUserPanel" class="p-5" style="width:auto;display:none">
            <a href="#" id="_um_lnkbackToUserList" class="fw-bold btn btn-sm btn-outline-primary"><i class="fa fa-chevron-left" style="color:blue"></i> Back</a> 
          <div class="row border border-rounded p-5 mt-3">       
            <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    <label class="control-label">Official ID</label> &nbsp;<span style="color:grey;">ID of driver or merchant</span> &nbsp; <a id="_um_adduser_linkFindPerson" class="btn btn-sm btn-outline-success" href="javascript:void(0)" style="color:green"><i class="fa fa-search"></i></a>
