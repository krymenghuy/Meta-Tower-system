                        ...
                        <div class="row">
                                ...
                                <div class="form-group col-lg-3">
                                    <span class="simple-label">Name</span>
                                        <div><input type="text" data-ffield="name" data-field="name" data-required="1" class="form-control data-input"></div>
                                    </div>
                                   ...
                                   <div class="form-group col-lg-3">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div><input type="text"  data-ffield="description" data-field="description" data-datatype="string" data-required="1" class="form-control data-input"></div>
                                    </div>
                  ...
                  <div style="width:100%;margin-top:10px">
                                            ...
                                            <div id="_itemform_purchase_info">
                                                            <div class="row">
                                                                    <div class="form-group col-lg-5">
                                                                            <span class="simple-label">Cost price &nbsp;<a id="_itemform_lnkNewOrg" href="javascript:void(0)">View History</a> </span>
                   ...
                   <div style="width:100%;position:fixed;bottom:15px;">
                            <div class="form-inline" style="float:left;margin-left:7vw">
                                <button id="_itemform_btnClose" type="button" class="vs-btn-lg vs-btn-danger" style="min-width:100px"><i class="fa fa-times"></i> Close</button>&nbsp;
                                <button id ="_itemform_btnSave" type="button" class="vs-btn-lg  vs-btn-primary" style="min-width:100px"><i class="fa fa-save"></i> Save</button>&nbsp;
...
<div class="modal fade" id="dlgNewOrg" tabindex="-1" role="dialog" aria-labelledby="dlgCategoryTitle" aria-hidden="true">
  <div class="modal-dialog" role="dialog">
    <div class="modal-content">
      ...
      <img src="{{asset('/assets/images/icons/category_icon.png')}}" style="width:38px;">&nbsp;<h5 class="modal-title" id="dlgCategoryTitle">New Category</h5>
