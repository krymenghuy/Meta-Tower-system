    ...
    <div style="width:100%">
        ...
        <div id="_itemform_general_info" class="card vs-card">
            <div class="row">
                ...
                <div class="form-group col-lg-3">
                    ...
                    <div><input type="text" data-ffield="name" data-field="name" data-required="1"
                ...
                <div class="form-group col-lg-3">
                    ...
                    <div>
                        <select type="text" data-field="group_id" data-ffield="Item Group" data-datatype="number"
                            data-required="1" class="modal-select2 data-input"> </select>
                    </div>
                </div>
                ...
                <div class="form-group col-lg-3">
                    ...
                    <div>
                        <select type="text" data-field="cat_id" data-ffield="category" data-datatype="number"
                            data-required="1" class="modal-select2 data-input"> </select>
                    </div>
                </div>
                ...
                <div class="form-group col-lg-3">
                    ...
                    <div>
                        <select type="text" data-field="detail_type_id" data-ffield="detailed type"
                            data-datatype="number" data-required="1" class="modal-select2 data-input"> </select>
                    </div>
                </div>

                <div class="form-group col-lg-12">
                    <span class="simple-label">Description</span>
                    <div><input type="text" data-ffield="description" data-field="description" data-datatype="string"
                            data-required="1" class="form-control data-input"></div>
                </div>
                ...
                <div id="_itemform_purchase_info">
                    <div class="row">
                        <div class="form-group col-lg-5">
                            <span class="simple-label">Cost price &nbsp;<a id="_itemform_lnkNewOrg"
                                    href="javascript:void(0)">View History</a> </span>
                            <div><input type="number" class="form-control data-input"> </div>
                        </div>

                        <div class="form-group col-lg-4">
                            <span class="simple-label">Cost Account</span>
                            <div><select class="modal-select2 data-input"></select></div>
                        </div>
        ...
        <div style="width:100%;position:fixed;bottom:15px;">
            <div class="form-inline" style="float:left;margin-left:7vw">
                <button id="_itemform_btnClose" type="button" class="vs-btn-lg vs-btn-danger" style="min-width:100px"><i
                        class="fa fa-times"></i> Close</button>&nbsp;
                <button id="_itemform_btnSave" type="button" class="vs-btn-lg  vs-btn-primary"
                    style="min-width:100px"><i class="fa fa-save"></i> Save</button>&nbsp;
...
<!--begin::newCategoryDialog -->
<div class="modal fade" id="dlgNewOrg" tabindex="-1" role="dialog" aria-labelledby="dlgCategoryTitle"
    aria-hidden="true">
    <div class="modal-dialog" role="dialog">
        <div class="modal-content">
            <div class="modal-header">
                <img src="{{ asset('/assets/images/icons/category_icon.png') }}"
                    style="width:38px;">&nbsp;<h5 class="modal-title" id="dlgCategoryTitle">New Category</h5>
