        ...
        <div class="container-fluid">
            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="chart-responsive">
                                        ...
                                        <canvas id="myPieChart" height="380vw" style="display: block;"
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6">
                            ...
                            <div class="small-box oval-top-left-danger" style="border-bottom: 7px solid #F63A07;">
                                <div class="inner">
                                    <h3 id="dbc_principal" class="dbc-card-value" data-field="principal"
                                        style="font-size:1.2em;margin-bottom:2.8vw;">$0</h3>
                                    <p class="dbc-card-title">Total Principal</p>
                                    <div class="dbc-card-line"></div>
                                    <span class="dbc-card-period">last 12 months</span>
                                </div>
                                <div class="icon">
                                    <i class="ion"><img class="ion"
                                            src="{{ asset('assets/images/icons/principal.png') }}"
                                            style="height:3.5vw;margin-top:-3vw;"></i>
                                </div>
                        ...
                        <div class="col-lg-6 col-6">
                            ...
                            <div class="small-box oval-top-left-warning" style="border-bottom: 7px solid orange;">
                                <div class="inner">
                                    <h3 id="dbc_total_earnings" class="dbc-card-value" data-field="discount_principal"
                                        data-item="amount" data-unit="usd" style="font-size:1.2em;margin-bottom:2.8vw;">
                                        $0</h3>
                                ...
                                <div class="icon">
                                    <i class="ion"><img class="ion"
                                            src="{{ asset('assets/images/icons/discount_percent.png') }}"
                                            style="height:3.5vw;margin-top:-3vw;"></i>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6">
                            <!-- small box -->
                            <div class="small-box oval-top-left-primary"
                                style="border-bottom: 7px solid rgba(20, 255, 0, 0.3);">
                                <div class="inner">
                                    <h3 id="dbc_merchant_count" class="dbc-card-value" data-field="principal_paid"
                                        data-item="amount" style="font-size:1.2em;margin-bottom:2.8vw;">0</h3>
                                    <p class="dbc-card-title">Paid Principal <span class="dbc-card-value"
                                            data-field="principal_paid_percent"
                                            style="color:green;padding:3px;font-size:1.2em;font-weight:bold"></span></p>
                                    <div class="dbc-card-line"></div>
                                    <span class="dbc-card-period">last 12 months</span>
                                </div>
                                <div class="icon">
                                    <i class="ion"><img class="ion"
                                            src="{{ asset('assets/images/icons/interest.png') }}"
                                            style="height:3vw;margin-top:-3vw;"></i>
                                </div>
                        ...
                        <div class="col-lg-6 col-6">
                            <!-- small box -->
                            <div class="small-box oval-top-left-primary"
                                style="border-bottom: 7px solid rgba(0, 255, 209, 0.3);">
                                <div class="inner">
                                    <h3 id="dbc_earnings" class="dbc-card-value" data-field="earnings"
                                        data-item="amount" data-unit="usd" style="font-size:1.2em;margin-bottom:2.8vw;">
                                        0</h3>
                                ...
                                <div class="icon">
                                    ...
                                    <i class="ion"><img class="ion"
                                            src="{{ asset('assets/images/icons/earnings.png') }}"
                                            style="height:3vw;margin-top:-3vw;"></i>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6">
                            <!-- small box -->
                            <div class="small-box oval-top-left-blue"
                                style="border-bottom: 7px solid rgba(255, 245, 0, 0.3);">
                                <div class="inner">
                                    <h3 id="dbc_borrower_count" class="dbc-card-value" data-field="borrower_count"
                                        data-item="count" style="font-size:1.2em;margin-bottom:2.8vw;">0</h3>
                                ...
                                <div class="icon">
                                    <i class="ion"><img class="ion"
                                            src="{{ asset('assets/images/icons/person1.png') }}"
                                            style="height:3vw;margin-top:-3vw;"></i>
                                </div>
                        ...
                        <div class="col-lg-6 col-6">
                            <!-- small box -->
                            <div class="small-box oval-top-left-blue"
                                style="border-bottom: 7px solid rgba(88, 105, 95, 0.3);">
                                <div class="inner">
                                    <h3 id="dbc_finished_loan_count" class="dbc-card-value"
                                        data-field="finished_loan_count" data-item="count" data-unit="loans"
                                        style="font-size:1.2em;margin-bottom:2.8vw;">0</h3>
                                ...
                                <div class="icon">
                                    <i class="ion"><img class="ion"
                                            src="{{ asset('assets/images/icons/finished loan.png') }}"
                                            style="height:3.5vw;margin-top:-3vw;"></i>
                                </div>
                ...
                <section class="col-lg-12 connectedSortable ui-sortable">
                    ...
                    <div class="card" style="border:none;min-height:495px;height:auto;">
                        ...
                        <div class="position-relative mb-4">
                            ...
                            <canvas id="myBarChart" height="120vw" style="display:block"
                                class="chartjs-render-monitor"></canvas>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <p class="d-flex flex-column">
                                    <span id="dbc_barchart_summary_value"
                                        class="text-bold text-lg barchart-summary-value">$0</span>
                                    <span id="dbc_barchart_summary_title" class="barchart-summary-value-title">Latest
                                        Earnings</span>
                                </p>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" style="border:none;background:none;padding-bottom:0px">
                            <span id="dbc_monthly_pmt_title" class="card-title dashboard-title">Last 12 Months
                                Collections</span>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" style="border:none;background:none;padding-bottom:0px">
                            <span id="dbc_daily_pmt_title" class="card-title dashboard-title">Pending
                                Applications</span>
                        </div>
                        <div class="card-body" style="padding-top:0px">
