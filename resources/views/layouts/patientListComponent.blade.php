             ...
             <div class="d-flex justify-content-between" style="padding:10px">
                <div class="d-flex col-md-6">
                     <button class="vs-btn-md vs-btn-md-primary" id="_pal_btnNewPatient">
                        ...
                        <span class="trans-text" data-langprop="buttons.New Patient">New Patient</span>
                    </button>
                     ...
                     <a id="_pal_btnSearch" class="vs-btn-round vs-btn-success" href="javascript:void(0)">
             ...
             <div class="modal-body">
                 <div class="row" id="_pal_dlPatient_body">
                     <div class="form-group col-lg-6">
                         ...
                         <div>
                            <input type="text" data-required="0" data-field="code" data-ffield="Patient ID" class="form-control data-input" readOnly/>
                        </div>
                     </div>
                     ...
                     <div class="form-group col-lg-6">
                         ...
                         <div>
                            <input type="text" data-required="1" data-field="name" data-ffield="Name" class="form-control data-input" id="_pat_name">
                        </div>
                     </div>
                     ...
                     <div class="form-group col-lg-6">
                         ...
                         <div>
                            <select data-required="1" data-field="nationality_id" data-ffield="Nationality" class="modal-select2 data-input" id="_apt_nat"></select>
                        </div>
                     </div>
                     ...
                     <div class="form-group col-lg-6">
                         ...
                         <div>
                            <input data-type="number" data-ffield="Phone Number" data-field="phone_number" class="form-control data-input"/>
                        </div>
                     </div>
                     ...
                     <div class="form-group col-lg-6">
                         ...
                         <div>
                            <select data-type="string" data-ffield="Patient Type" data-field="patient_type" class="modal-select2 data-input" id="_pat_type"></select>
                        </div>
                     </div>
                     ...
                     <div class="form-group col-lg-12">
                         ...
                         <div>
                            <input type="text" data-field="remarks" data-ffield="Remarks" class="form-control data-input" id="_pat_remarks">
                        </div>
                     </div>
                 ...
                 <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-success" id="_pal_dlPatient_btnSave">
