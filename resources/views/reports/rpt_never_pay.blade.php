      ...
      font-weight:bold;
                ...
                <?php
                 ...
                 echo '<tbody>';
                  ...
                  echo '<tr class="total-row"><td colspan="4" style="text-align:right">Total: </td><td>'.$cur.$total.'</td><td>'.$cur.$total_principal_disc.'</td><td>'.$cur.$total_paid.'</td><td>'.$cur.$total_interest_paid.'</td></tr>'; 
                  echo '</tbody></table>';
                  if ($numero ==0) {
