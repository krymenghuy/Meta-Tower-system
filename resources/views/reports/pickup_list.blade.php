...
<table class="table">
    ...
    <tbody>
       <?php
        ...
        echo '<tr class="total-row"><td colspan="6"><span class="fw-semibold text-right p-1">TOTAL: </span></td> <td colspan="1"><span class="p-1 fw-semibold text-left">'.$cur. number_format($total_cod,2,'.','').'</span></td></tr>';
       ?>
    </tbody>
</table>