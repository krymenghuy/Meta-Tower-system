...
<html>
  ...
  <body>
    <div class="d-flex align-items-center justify-content-center h-100 print-middle">
      <div class="d-block w-50 border border-1 border-success rounded-4 p-3 print shadow">
        <div class="d-flex align-items-center w-100">
          <div class="d-block">
            <h4><?php echo isset($branch->name) ? $branch->name : null ?></h4>
            <div class="py-2">
              <span class="pe-2 fw-semibold">អាសយដ្ឋាន: </span>
              <span><?php echo isset($branch->address_kh) ? $branch->address_kh : "គ្មាន" ?></span>
            </div>
            <div class="py-2">
              <span class="pe-2 fw-semibold">លេខទូរស័ព្ទ: </span>
              <span><?php echo isset($branch->phone_number) ? $branch->phone_number : "គ្មាន" ?></span>
            </div>
            <div class="py-2">
              <span><?php echo isset($branch->website) ? $branch->website : null ?></span>
            </div>
          </div>
        ...
        <div class="d-flex align-items-center justify-content-center">
          <div>
            <h3><?php echo isset($title) ? $title : null ?></h3>
          </div>
        </div>
        <div class="d-flex align-items-center w-100">
          <div class="d-flex align-items-end">
            <span class="pe-2 fw-semibold">Amount</span>
            <span><?php echo isset($payment->amount) ? $payment->amount : "គ្មាន" ?></span>
          </div>
          <div class="d-flex justify-content-end w-100">
            <div class="d-block">
              ...
              <p>
                ...
                <span><?php echo isset($payment->payment_date) ? $payment->payment_date : "គ្មាន" ?></span>
              </p>
            </div>
          </div>
        </div>
        <div class="d-block">
          <div class="d-flex align-items-center w-100 py-2">
            ...
            <div class="d-flex align-items-center justify-content-center w-100">
              <span><?php echo isset($payment->payer_name) ? : "គ្មាន" ?></span>
            </div>
          </div>
          <div class="d-flex align-items-center w-100 py-2">
            <span class="pe-2 fw-semibold text-nowrap">The sum of</span>
            <div class="d-flex align-items-center justify-content-center w-100">
              <span><?php echo "គ្មាន" ?></span>
            </div>
          </div>
          <div class="d-flex align-items-center w-100 py-2">
