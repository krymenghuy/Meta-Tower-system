...
<head>
    ...
    <?php
    StyleManager::render('ypg-style', 1, 9);
    ?>
    <style>
    ...
    ScriptManager::render('ypg-components', 1, 198);
                ...
                <div id="_p2" class="h-100 mt-1" id="kt_content">
                    <div id="" class="h-100">
                        <div class="pb-2" id="_app_content">
                            ...
                            @include('layouts.ypg.jobsLevelComponent')
                            @include('layouts.ypg.payrollComponent')
                            @include('layouts.ypg.payrollListComponent')
                            @include('layouts.ypg.departmentComponent')
                            @include('layouts.ypg.positionComponent')
                            @include('layouts.ypg.leaveUnFormComponent')
                            @include('layouts.ypg.leaveComponent')
                            @include('layouts.ypg.warningComponent')
                            @include('layouts.ypg.attendanceComponent')
                            @include('layouts.ypg.staffAttendanceComponent')
                            @include('layouts.ypg.employeemovementComponent')
                            @include('layouts.ypg.employeeBenefitComponent')
                            @include('layouts.ypg.accountComponent')
                            @include('layouts.ypg.taxbracketComponent')
                            @include('layouts.ypg.walletAccountComponent')
                            @include('layouts.ypg.holidayComponent')
                            @include('layouts.ypg.workshiftComponent')
                            @include('layouts.ypg.workShiftListComponent')
                            @include('layouts.ypg.benefitDisbursementComponent')
                            @include('layouts.ypg.benefitDisbursePolicyComponent')
                            @include('layouts.ypg.benefitComponent')
                            @include('layouts.ypg.exitCheckPointComponent')
                            @include('layouts.ypg.exitFormComponent')
                            @include('layouts.ypg.checkPointComponent')
