<!DOCTYPE html>
<html lang="<?php echo Session::get('lang', 'en'); $user = App\Services\Umt\XAuthService::user(); ?>">
    <head>
        <base href="../">
        <meta charset="utf-8" />
        ...
        ?>
        <?php
            ScriptManager::render('attendance-script', 1,9);
        ?>
    </head>
    <body>
        ...
        <div class="h-100">
            @include('layouts.bhr.scanAttendanceComponent')
        </div>
    </body>
</html>