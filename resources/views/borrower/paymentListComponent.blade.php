...
<div id="_bor_paymentListComponent" style="display:none">
                   ...
                   <div style="width:100%;"><span id="_bor_payments_title" class="pmt-table-title">Student Grant Loan Payments</span></div>
                   ...
                   <div class="container pt-3" style="overflow:hidden">
                        <div class="form-inline" style="float:left;margin-left:15px;">
                           ...
                           <div> <input type="text" class="form-control" id="_bor_search_pmt" placeholder="Search receipt number/ date"></div>
                           &nbsp;&nbsp;<button id="btnRefresh" type="button" class="btn btn-primary"><i class="fas fa-list-alt"></i> Refresh</button>
                           &nbsp;&nbsp;<button type="button" id="btnChangePwd" class="btn btn-success"><i class="fa fa-lock"></i> Change Password</button>
                        </div>
                    </div>   

                    <div class="container pt-3" style="overflow:hidden">
                         <div id="_bor_loan_info_fields" style="display:flex;flex-direction:row;border:1px solid grey; padding:5px;border-radius:5px;margin-left:15px;margin-right:15px">
...
<!--begin::changePwd-->
<div class="modal fade" id="_dlgChangePwd" tabindex="-1" role="dialog" aria-labelledby="_dlgChangePwd_title" aria-hidden="true">
