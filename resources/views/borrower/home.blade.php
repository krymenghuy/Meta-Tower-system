...
<head>
    ...
    <script defer src="{{ asset('assets/borrower-js/securitycom.js') }}" type="text/javascript"></script>
            ...
            <div class="row pt-4">
                ...
                <div class="col-md-9">
                    ...
                    <div class="rowAddress d-flex justify-content-between" style="margin-top:-15px">
                        ...
                        <span class="btn-logout"><a id="_bor_btnLogout" class="d-flex btn btn-outline-danger" style="border-radius:35px;border:1.5px solid red; background-opacity:0.6" href="javascript:void(0)"><img src="{{ asset('assets/borrower-css/arrow-right-from-bracket-solid.svg') }}" alt="">Logout</a></span>
                    </div>
    ...
    <div class="container-fluid">
       <div style="width:100%">
           <div class="form-inline tab-buttons">
                <button type="button" id="_bor_btnPayments" class="btn btn-outline-success" style="border-radius:15px;width:100px">PAYMENTS</button> &nbsp;
                <button type="button" id="_bor_btnLoanInfo"  class="btn btn-outline-success" style="border-radius:15px;width:100px">LOAN INFO</button> &nbsp;
                <button  type="button" id="_bor_btnProfile"  class="btn btn-outline-success" style="display:none;border-radius:15px;width:100px">PROFILE</button>
           </div>
       </div> 
