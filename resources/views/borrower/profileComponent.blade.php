                  ...
                  <div id="_profile_personal_data_view" style="width:100%">
                                ...
                                <div class="col-lg-10 col-md-10">
                                            <div class="row">
                                                    <div class="form-group col-lg-3">
                                                        ...
                                                        <div><input id="_profile_nid" type="text" data-field="n_id" data-required="1" class="form-control data-input person-data"></div>
                                                    </div>
                                                    <div class="form-group col-lg-3">
                                                    ...
                                                    <div class="form-group col-lg-3">
                                                        <span class="simple-label">Occupation&nbsp;<a id="_profile_lnkNewOccupation" href="javascript:void(0)"><i class="fa fa-plus" style="color:green"></i></a></span>
                                                        <div><select id="_profile_occupation" data-field="occupation_id" data-datatype="string" data-required="1" class="modal-select2 data-input person-data"></select></div>
                                                    </div>
                                    ...
                                    <div class="col-lg-2 col-md-2">
                                                ...
                                                <div class="photo-buttons" style="display:none">
                                                    ...
                                                    &nbsp;&nbsp;<a href="#" id="_profile_lnkDeletePhoto" class="btn btn-sm btn-outline-danger">Delete</a>
                                        ...
                                        <div class="row">
                                                    <div class="form-group col-lg-1">
                                                        ...
                                                        <div class="form-group col-lg-2">
                                                            ...
                                                            <div><select id="_profile_adr_city" data-field="adr_city_id" class="data-input modal-select2 person-data"></select></div>
                                                        </div>

                                                        <div class="form-group col-lg-2">
                                                            <span class="simple-label">District</span>
                                                            <div><select id="_profile_adr_district" data-field="adr_district_id" class="data-input modal-select2 person-data"></select></div>
                                                        </div>

                                                        <div class="form-group col-lg-2">
                                                            <span class="simple-label">Commune</span>
                                                            <div><select id="_profile_adr_commune" data-field="adr_commune_id" class="data-input modal-select2 person-data"></select></div>
                                                        </div>
                                            </div>
                                </div>
                    ...
                    <div style="width:100%;margin-top:10px">
                            <div id="_profile_academic_view" style="width:100%;">
                                            ...
                                            <div id="_profile_view" class="flat-box" style="margin-top:-20px;">
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group col-lg-6">
                                                                            <span class="simple-label">Program of study &nbsp;<a id="_profile_lnkNewProgram" href="javascript:void(0)"><i class="fa fa-plus" style="color:green"></i></a> </span>
                                                                            <div><select id="_profile_program" data-field="program_id" class="form-control data-input modal-select2"></select></div>
                                                                    </div>

                                                                    <div class="form-group col-lg-2">
                                                                            <span class="simple-label">Cumulative GPA</span>
                                                                            <div><input type="number" id="_profile_gpa" data-field="cgpa" class="form-control data-input"></div>
                                                                    </div>
                                                            </div>
                                            </div>
                            </div>
                           ...
                           <div id="_profile_documents_view" style="width:100%;display:none">
                                    <div class="alert alert-info" style="margin-top:10px"> <i class="fas fa-receipt"></i> SUPPORT DOCUMENTS &nbsp; <a id="_profile_lnkAddDocument" href="#"> <i class="fa fa-plus"></i></a></div>
                                        <div id="_profile_docs" class="flat-box" style="margin-top:-20px">
                                            <input type="file" id="_profile_docs_input" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" style="display:none"> 
                   ...
                   <div style="width:100%;position:fixed;right:15;bottom:15px;display:none;">
                            <div class="form-inline" style="float:right;margin-right:13vw">
                                <button id="_profile_btnClose" type="button" class="vs-btn-lg vs-btn-danger" style="min-width:100px"><i class="fa fa-times"></i> Close</button>&nbsp;
                                <button id ="_profile_btnSave" type="button" class="vs-btn-lg  vs-btn-primary" style="min-width:100px"><i class="fa fa-save"></i> Save</button>
                            </div>
                 </div>
