    ...
    <div id="kt_aside_menu" class="kt-aside-menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
        <div class="kt-aside__brand kt-grid__item" id="kt_aside_brand">
            <div class="kt-aside__brand-logo pt-2">
                <img src="{{ asset('assets/images/logo/ksmlogo.png') }}" alt="" class="img-logo" />
            </div>
        ...
        <ul class="kt-menu__nav" id="_dms_aside_menus" style="display:none">
            ...
            <!-- <li class="kt-menu__item" aria-haspopup="true" <?php v_display(231); ?>>
                <a href="DashboardComponent" modid="231" class="menu-item kt-menu__link">
                    <span class="kt-menu__link-icon">
                        <img class="icons opacity-icons" src="{{ asset('assets/images/icons/menu_icons/dashboard.svg') }}" />
                    </span>
            ...
            <!-- <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"<?php v_display(null, [100, 101]); ?>>
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    <span class="kt-menu__link-icon">
                        <img class="icons opacity-icons" src="{{ asset('assets/images/icons/menu_icons/user_role.svg') }}" />
                    </span>
                    <span class="kt-menu__link-text text-nowrap " vslang="menus.User Roles & Permissions">User Management</span>
                ...
                <div class="kt-menu__submenu"><span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(101);?>>
                            <a href="RoleManagementComponent" modid="101" class="menu-item kt-menu__link">
                                <span class="kt-menu__link-icon">
                                    <img class="icons opacity-icons" src="{{ asset('assets/images/icons/menu_icons/kub.svg') }}" />
                                </span>
                                <span class="kt-menu__link-text font-color " vslang="menus.Role Management"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(100);?>>
                            <a href="UserManagementComponent" modid="100" class="menu-item kt-menu__link ">
                                <span class="kt-menu__link-icon">
                                    <img class="icons opacity-icons" src="{{ asset('assets/images/icons/menu_icons/people.svg') }}" />
                                </span>
                                <span class="kt-menu__link-text font-color " vslang="menus.User Management"></span>
                            </a>
                        </li>
...
<script>
        (() => {
        const __dx = document.querySelector('#_dms_aside_menus');
        if (!__dx) return;

        const setMenuScrollStyle = () => {
            __dx.style.height = (window.innerHeight - 65) + 'px';
            __dx.style.overflowY = 'auto';
        };

        // Initialize global vsapp if needed
        ...
        // Fallback on DOM ready if not yet translated
        ...
        // On window resize
        window.addEventListener('resize', setMenuScrollStyle);

        // On hover show scrollbar, on leave hide
