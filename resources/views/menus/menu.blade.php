        ...
        <ul class="kt-menu__nav" id="_dms_aside_menus" style="display:none">
            <li class="kt-menu__item" aria-haspopup="true">
                <a href="DashboardComponent" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.Dashboard"></span>
                </a>
            </li>
            ...
            <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.Registration"></span>
                ...
                <div class="kt-menu__submenu ">
                    ...
                    <ul class="kt-menu__subnav">
                      <li class="kt-menu__item" aria-haspopup="true">
                            <a href="EnrolledStudentsComponent" class="menu-item kt-menu__link">
                               <span class="kt-menu__link-icon">
                                    <img class="icons" src="{{asset('assets/images/icons/registration.png') }}"/>
                                </span>
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Enrolled Students"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="OnLeaveStudentsComponent" class="menu-item kt-menu__link">
                                <span class="kt-menu__link-icon">
                                    <img class="icons" src="{{asset('assets/images/icons/registration.png') }}"/>
                                </span>
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.On-leave Students"></span>
                            </a>
                        </li>
            ...
            <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.Payment Processing"></span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
                <div class="kt-menu__submenu ">
                    <span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="FindStudentComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Find Students"></span>
                            </a>
                        </li>
                        ...
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="DepositFeeComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Deposits"></span>
                            </a>
                        </li>
                        ...
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="InvoicesComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Invoices"></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.Student Management"></span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
                <div class="kt-menu__submenu ">
                    <span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="StudentInformationComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Student Information"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true">
                        ...
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="RequestDiscountComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Discounts"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="StudentGroupComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Groups"></span>
                            </a>
                        </li>
                        <!-- <li class="kt-menu__item" aria-haspopup="true">
            ...
            <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.Approvals"></span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
                <div class="kt-menu__submenu ">
                    <span class="kt-menu__arrow"></span>
            ...
            <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.Parent Account"></span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
                <div class="kt-menu__submenu ">
                    <span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="ManageAccountComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Manage Account"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="AccountRequestComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Account Requests"></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.ID Card Printing"></span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
                <div class="kt-menu__submenu ">
                    <span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="PrintStudentCardsComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Print Student Cards"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="IdCardSettingsComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.ID Card Settings"></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.Pricing and Discounts"></span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
                <div class="kt-menu__submenu ">
                    <span class="kt-menu__arrow"></span>
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="TuitionFeeComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Tuition Fees"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="PolicyDiscountComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Policy Discounts"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="NonTuitionFeeComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Non-tuition Fee"></span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="kt-menu__submenu ">
                    ...
                    <li class="kt-menu__item" aria-haspopup="true">
                            <a href="TermComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Terms"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="AcademicYearComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Academic Years"></span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="kt-menu__subnav">
                        ...
                        <li class="kt-menu__item" aria-haspopup="true">
                            <a href="ProgramComponent" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text trans-text" data-langprop="menus.Programs"></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.User Management"></span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
            ...
            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a id="_main_lnkLogout" href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text trans-text" data-langprop="menus.Log Out"></span>
                </a>
            </li>
        </ul>
    </div>
