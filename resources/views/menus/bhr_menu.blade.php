        ...
        <ul class="kt-menu__nav" id="_dms_aside_menus" style="display:none">
            ...
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(214); ?>>
                <a href="PositionManagementComponent" modid="214" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Position Menagement"></span>
                </a>
            </li>
            ...
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(206); ?>>
                <a href="PromotionAndDemotionComponent" modid="206" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color text-nowrap trans-text" data-langprop="menus.Promotion And Demotion"></span>
                </a>
            </li>
            ...
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(209); ?>>
                <a href="SeniorityPaymentComponent" modid="209" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Seniority Payments"></span>
                </a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(209); ?>>
            ...
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(209); ?>>
                <a href="ResignationComponent" modid="209" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Best Staff Recognitions"></span>
                </a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(209); ?>>
                <a href="ResignationComponent" modid="209" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Exit Clearancea Forms"></span>
                </a>
            </li>
            <li class="kt-menu__section" <?php v_display(null,[209,218,220,210]);?>>
             ...
             <li class="kt-menu__item" aria-haspopup="true" <?php v_display(105); ?>>
                <a href="LeaveMenagementComponent" modid="105" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Leave Menegement"></span>
                </a>
            </li>
            <li class="kt-menu__section" <?php v_display(null,[209,218,220,210]);?>>
             ...
             <li class="kt-menu__item" aria-haspopup="true" <?php v_display(105); ?>>
                <a href="PlayrollSetupComponent" modid="105" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Playroll Setup"></span>
                </a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(105); ?>>
                <a href="StaffAccountComponent" modid="105" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Playroll / Staff Accounts"></span>
                </a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(105); ?>>
                <a href="PlayrollReportingComponent" modid="105" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Playroll Reporting"></span>
                </a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(105); ?>>
                <a href="PlayrollDisbursementComponent" modid="105" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Playroll Disbursement"></span>
                </a>
            </li>
            ...
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(209); ?>>
                <a href="StaffAttendanComponent" modid="209" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Staff Attendance"></span>
                </a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(209); ?>>
                <a href="AccountMenagmentComponent" modid="209" class="menu-item kt-menu__link">
                    ...
                    <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Account Menagement"></span>
                </a>
            </li>
            <li class="kt-menu__item" aria-haspopup="true" <?php v_display(209); ?>>
                <a href="WarningComponent" modid="209" class="menu-item kt-menu__link">
            ...
            <!-- <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover" <?php v_display(null,[106,218])?>>
             ...
             <li class="d-none kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover" <?php v_display(null,[220,210,102,221,216,212]);?>>
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    <span class="kt-menu__link-icon">
                    ...
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(105); ?>>
                            <a href="CountryZonesComponent" modid="105" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Holiday Setup"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(220); ?>>
                            <a href="AutomaticEmployeeComponent" modid="220" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Automatic Employee"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(230); ?>>
                            <a href="DepartmentListComponent" modid="220" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Department List"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(230); ?>>
                            <a href="PositionListComponent" modid="220" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Position List"></span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="kt-menu__subnav">
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(105); ?>>
                            <a href="WholeDatadaseBackupComponent" modid="105" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Whole Database Backup"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(220); ?>>
                            <a href="RestorDatabaseComponent" modid="220" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Restore Database"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(230); ?>>
                            <a href="DataInportComponent" modid="220" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Data Import"></span>
                            </a>
                        </li>
                        <li class="kt-menu__item" aria-haspopup="true" <?php v_display(230); ?>>
                            <a href="DataExportComponent" modid="220" class="menu-item kt-menu__link">
                                ...
                                <span class="kt-menu__link-text font-color trans-text" data-langprop="menus.Data Export"></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"<?php v_display(null, [100, 101]); ?>>
                <a href="javascript:void(0)" class="kt-menu__link kt-menu__toggle">
                    ...
                    <span class="kt-menu__link-text text-nowrap trans-text" data-langprop="menus.User Roles & Permissions">User & Role Management</span>
                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                </a>
