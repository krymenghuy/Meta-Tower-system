...
<head>
    ...
    <?php
    StyleManager::render('prm-style', 1, 69);
    ?>
    <style>
    ...
    ScriptManager::render('prm-components', 1, 269);
                           ...
                           <div id="_main_top_right_menus" class="mainview-top-right">
                                <div class="d-flex flex-grow-1 show--title">
                                  <div class="screen-info" id="kt_header_menu_wrapper">
                                            <span class="mb-0 text-nowrap screen-title" vslang="titles.dashboard" style="text-transform:capitalize;" id="screen_title"></span>
                                        </div>
                                ...
                                <div id="_main_top_right_menus" class="d-flex flex-row flex-wrap align-items-center justify-content-end gap-2 px-3">
