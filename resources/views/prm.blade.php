...
<head>
    ...
    <?php
    StyleManager::render('prm-style', 1, 49);
    ?>
    <style>
    ...
    <?php
    ScriptManager::render('priority-one', 1, 13);
    ScriptManager::render('primary', 1, 17);
    ScriptManager::render('primary-defer', 1, 41);
    ScriptManager::render('prm-components', 1, 249);
