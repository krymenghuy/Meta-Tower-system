...
<head>
    ...
    <?php
    StyleManager::render('prm-style', 1, 48);
    ?>
    <style>
    ...
    <?php
    ScriptManager::render('priority-one', 1, 12);
    ScriptManager::render('primary', 1, 16);
    ScriptManager::render('primary-defer', 1, 40);
    ScriptManager::render('prm-components', 1, 248);
