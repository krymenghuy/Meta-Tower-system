            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-sm kt-portlet--responsive-mobile" id="kt_page_portlet">
                    ...
                    <div class="kt-portlet__body">
                        {{ Form::open(array('route' => 'merchant.store', 'class' => 'kt-form', 'enctype' => 'multipart/form-data', 'files'=>'true')) }}
                            <div class="kt-portlet__body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('name_kh', '', array('class' => 'form-control')) }}
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('business_type', '', array('class' => 'form-control')) }}
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    {{ Form::button('<i class="fa fa-plus"></i> Add Commue', array('type' => 'submit', 'class' => 'btn btn-brand mb-2')) }}
